...
- [x] Run domestic finance sweep for BDI 2025 — **run manually 2026-07-24** (overnight batch died mid-job-6; re-run by hand). FY2025/26; **11 budget docs** staged to new-budget/BDI/2025/ (Loi 1/12 appropriation, **PTBA 2025-2026 estimates volume OBTAINED**, Loi 1/09 rectificative, **4 NATIVE-XLSX T3 execution canevas** MFBEN/MIDCSP/MCM/CENI — first machine-readable BDI budget artefacts, break the OCR wall on the execution side, 4 procurement plans incl. FSU own-source + SETIC e-gov), **1 prose**, **2 acquisitions** (exposé + PTBA modifié, both unpublished this year). Stage coverage: appropriated+revised+T3-executed held; T4/full-year + audit not yet published (PLR series ends FY2022/23). Budget-extract deferred to checkpoint.
