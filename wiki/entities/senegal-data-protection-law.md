...
- **Still unamended as of 27 Mar 2026 — the reform has not reached a vote.** Law No. 2008-12 remains the
  operative statute. Cybersecurity and AI-governance consultant **Saïkou Fall** told APS the law is
  *"devenue caduque"* measured against generative AI, that *"le Sénégal tarde encore … à mettre à jour"*
  its framework, and that a bill is *"dans le circuit"* awaiting a National Assembly vote — a position
  unchanged **straight through the February-2026 national biometric-ID breach**
  ([[senegal--dpi-id]]). He frames the cost as regulatory blind spots for the
  **[[cdp-senegal|CDP]]** while the **[[new-deal-technologique]]** scales up sensitive-data processing,
  and points to Maghreb states as having already aligned to the **GDPR** benchmark. Fall's is an expert
  assessment, not an official statement; **no amended text and no vote date is on file as of
  2026-07-20**. See [[gov.protect]], [[gov.legislate]], [[tech.ai]], [[SEN]]. Source:
