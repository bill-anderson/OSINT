...
The **harmonised biometric national ID card of the Alliance of Sahel States (AES)** — the identity counterpart to the AES common biometric passport, rolled out first in Burkina Faso from late 2025.

## Profile

- In **Burkina Faso**: unveiled by **[[oni-burkina-faso]]** on 1 Dec 2025 (decree 6 Nov 2025), replacing the CNIB as the **5th generation** of national ID; deliverable from **age 5**, mandatory from **age 13**, cost **3,500 FCFA**, polycarbonate. Bears the national name/flag **and** the AES logo with a bilingual (FR/EN) "AES Identity Card" label — aligned to ICAO standards.
- Part of the **[[alliance-of-sahel-states]]** (Burkina Faso, Mali, Niger) integration agenda after their ECOWAS exit — "harmonised at AES level while keeping national sovereignty." A pointed sovereignty/geopolitical statement (AES-wide identity + travel documents replacing the ECOWAS frame). See [[burkina-faso--dpi-id]], [[gov.regional]]. Source: [[2025-11-10 Burkina Faso introduces new AES biometric ID system (CIB-AES)]].
- **Cross-border diaspora enrolment pilot, Bamako (2026-06-01).** Burkina Faso's Security
  Minister Mahamadou Sana closed a pilot phase of **biometric enrolment of Burkinabè residents
  in [[MLI|Mali]]**, using mobile kits for **near-instant production of the CIB-AES and the AES
  Passport**, with data transmitted in near-real-time to central production platforms in Burkina
  Faso. Framed as a model for diaspora enrolment in embassies/consulates and toward unified AES
  consular cards — extending the CIB-AES rollout into **cross-border enrolment hosted on Malian
  soil**, a concrete AES identity-integration step. (Mali was never a WURI participant, so the
