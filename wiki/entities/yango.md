...
Ride-hailing / super-app platform **operating under Russian company Yandex** — the only such attribution
in the CMR corpus (the taxonomy has **no Russia `geopol.*` slug**; see the open taxonomy issue).

## Activity in this wiki

- **Platform-economy expansion (2026).** Four years in-country, **~150 local fleet partners**, expanding
  into delivery, e-commerce and **fintech** — the fintech ambition is what matters against the held
  MoMo/GIMACPAY material. Partnered **[[mtn-cameroon]]** on a **dedicated-driver SIM** offering (2025).
