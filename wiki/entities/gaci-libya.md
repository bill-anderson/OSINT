...
title: General Authority for Communications and Informatics (GACI, Libya)
places: [LBY]
...
Libya's Tripoli-based telecommunications and IT authority, custodian of the **National Telecommunications
and Informatics Strategy 2023-2027** and national internet infrastructure ([[infra.connect]],
[[infra.cybersec]]). A driver of Libya's digital-sovereignty agenda. See [[LBY]].

## Activity in this wiki

- **National root servers launched (2025-10).** [[sovereignty]] GACI brought Libya's **root servers**
  into service (Al-Madar Al-Jadid data centres, Tripoli + Benghazi), listed on root-servers.org —
  framed as national internet independence (faster local response, cybersecurity, system stability).
  Source: [[2025-10-26 Libya launches root servers in Tripoli and Benghazi — digital sovereignty]].
