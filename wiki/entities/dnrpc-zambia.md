...
title: Department of National Registration, Passport and Citizenship (DNRPC)
places: [ZMB]
topics: [dpi.id, dpi.registry, gov.protect, include.access, digital.rural, data.statistics]
lens: [sovereignty]
status: active
...
**Zambia's civil-registration and identity authority** — the department under the
**Ministry of Home Affairs and Internal Security (MoHAIS)** that issues the National
Registration Card (NRC), registers births and deaths, and builds and operates
**[[inris]]**. It is the operational counterpart to [[smart-zambia-institute]]'s
platform-and-e-government role: SZI runs the [[dzap]] build, DNRPC runs the registry.
Its Registrar General is **[[davies-chikalanga]]**; its minister is **[[jack-mwiimbu]]**.

## Activity in this wiki

- **Legacy digitisation and biometric enrolment (as of 2024-09).** DNRPC had digitised
  **~81% of legacy civil-registration records** and enrolled **1.5 million people**
  biometrically via [[inris]] — against a stated denominator of **9 million** adults.
  Physical NRC coverage of adults 16+ was given as **"over 88 percent"** in one paragraph
  and **89 percent** in another *of the same UNDP article*; the held [[dzap]] PAD puts it
  at **~94% of adults (2021)**. Different vintages, and one source disagrees with itself —
  recorded, not reconciled. Source:
...
- **Nationwide mobile NRC campaign (2025-04-10).** [[jack-mwiimbu]] launched a
  **three-month** campaign targeting **~3.5 million** citizens across all **ten provinces**,
  focused on far-flung areas with no registration offices, under a ministerial directive to
  the Registrar General. Source:
...
- **Named governance risks (UNDP, 2024-09).** Multiple agencies issuing their own IDs on
  **different AFIS/ABIS**; Data Protection Act training needed across **145+ offices in 10
  provinces**; legal updates required to the **National Registration Act** and **Citizenship
  Act**. DNRPC's next INRIS phase was to add public-awareness campaigns, registration points
  near communities, a **unique legal ID number**, an API manager and improved child
  registration, phasing out the old system. Source:
  [[2024-09-17 DPI Safeguards come online in Zambias next phase of digital integration]].

## Related

[[inris]] · [[jack-mwiimbu]] · [[davies-chikalanga]] · [[smart-zambia-institute]] ·
[[zrhcp]] · [[ZMB]] · [[zambia--dpi-id]] · [[dpi.id]] · [[dpi.registry]]
