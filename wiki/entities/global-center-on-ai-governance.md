...
A South Africa-based research organisation working on AI governance from a Global-South vantage,
founded/led by **Rachel Adams**. Best known in this wiki as the producer of the
[[global-index-on-responsible-ai]] (GIRAI), the most complete cross-country measure of whether
responsible-AI commitments translate into protection for people.

## Activity in this wiki

- **Publishes GIRAI.** The 2nd Edition (2026) assessed 135 countries on responsible-AI
  implementation, foregrounding the gap between framework adoption and real-world protection and
  the North–South "two-tier" divide in *binding* AI rules. See [[global-index-on-responsible-ai]],
