...
title: Lesotho National Identity and Civil Registry (NICR)
places: [LSO]
...
Lesotho's civil-registration and national-identity function — the **National Identification System** that
the World Bank has profiled as a GovTech case study, and the base for digital birth registration and the
country's DPI build-out (X-Road interoperability, a **[[mosip]]**-based biometric ID under
[[micsti-lesotho]]) ([[dpi.id]], [[dpi.registry]]). See [[LSO]].

## Activity in this wiki

- **Digital birth registration (2025-04).** [[dpi.registry]] Launched within the **Ntlafatsa Bana**
