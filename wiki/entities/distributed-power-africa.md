...
- **The Free State solar farm (2024-11-20).** ADC signed a **20-year PPA with DPA Southern Africa to
  establish a solar farm in the Free State**. The project powers **ADC's Cape Town data centres** and
  is to **eventually extend to its Johannesburg facilities**. Source:
  [[2024-11-20 Africa Data Centres expands by 20 megawatts to meet cloud, AI demand]].
- **The rationale, stated plainly — Finhai Munzara (2024-11-20).** ADC's interim CEO: "**Our
  renewable strategy is heavily geared towards South Africa because SA's energy grid is
  carbon-intensive.**" The cleanest statement in the wiki of why African data-centre operators build
  their own generation — not grid scarcity alone, but grid carbon intensity, and the residency-plus-
  sustainability demands of hyperscale customers. Source: same.
- **What it powers (as of 2024-07).** CPT1, the wheeled-solar-supplied Cape Town facility, went from
  **5.5 MW to 11.5 MW** of IT load with a **6 MW** uplift; ADC claims a **water usage effectiveness
  rating of zero** and hybrid air/liquid cooling. Source:
