...
title: Ministry of the Interior, Community Development and Public Security (Burundi)
places: [BDI]
...
The ministry responsible for Burundi's **civil registration and national identity** — the digital civil
registry and the long-delayed **biometric national ID card** ([[dpi.id]], [[dpi.registry]]). It also
championed the 2026 data-protection law, sequenced explicitly ahead of the ID rollout. Territorial
Administration Director-General: **Valentin Nahimana**; Minister (2026): **Léonidas Ndaruzaniye**. See
[[BDI]], [[burundi--dpi-id]].

## Activity in this wiki

- **Biometric national ID + digital civil registry unveiled (2026-05-06).** [[dpi.id]] The ministry
  presented the digital platform underpinning a new civil-status system and biometric ID card. Every
...
- **Data-protection law sequenced first (2026-01).** [[gov.protect]] Minister Ndaruzaniye presented the
  ...
  developing the software platform." Source:
