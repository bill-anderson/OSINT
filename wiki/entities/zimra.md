...
title: Zimbabwe Revenue Authority (ZIMRA)
places: [ZWE]
...
**Zimbabwe's tax authority**, and operator of the [[tarms-zimbabwe]] self-service portal
through which taxpayers register and obtain a **Taxpayer Identification Number (TIN)** —
a functional identifier sitting alongside the national ID architecture run by the
[[registrar-general-zimbabwe]].

## Activity in this wiki

- **Mandatory taxpayer registration via TaRMS.** Registration is **mandatory for all
  persons carrying out any trade or business in Zimbabwe**, including **Authorised
...
- [[tarms-zimbabwe]] · [[ZWE]] · [[dpi.govtech]] · [[dpi.id]]
