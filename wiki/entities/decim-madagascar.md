...
title: DECIM (Digital and Energy Connectivity for Inclusion in Madagascar)
places: [MDG]
topics: [infra.connect, infra.energy, include.access, dpi.id]
lens: []
status: active
...
- **Operational phase (2026-06).** [[include.access]] DECIM has distributed **664,000 digital devices**,
  continues fibre-optic rollout, and connects healthcare facilities and schools; reviewed with the World
  Bank alongside PRODIGY. Context: only **33.7% electricity access (2020)**; internet penetration **22%
  (2021)** rising to **6.71m users / 20.4% (end-2025)**. Sources:
