...
title: TCIB (Transactions Cleared on an Immediate Basis) — SADC cross-border payments
places: [XSA, BWA]
topics: [dpi.pay, gov.regional, include.access]
lens: []
status: active
last_reviewed: 2026-07-15
sources: [[2026-03-02 PayInc and First Capital Bank Botswana Launch Instant Cross-Border Payments (TCIB)]]
---

# TCIB (Transactions Cleared on an Immediate Basis)

The **SADC regional cross-border instant-payments scheme** — real-time low-value cross-border payments and remittances across Southern Africa, operated by **PayInc** (BankservAfrica's regional entity).
...
- [[XSA]] · [[BWA]] · [[dpi.pay]] · [[sadc]] · [[bank-of-botswana]]
