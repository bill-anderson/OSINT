...
type: entity
entity_type: company
title: Telekom Networks Malawi (TNM)
places: [MWI]
...
One of Malawi's two mobile network operators. TNM was the **first operator to pilot and launch 5G** in Malawi
(Bingu International Convention Centre, Lilongwe, Jul 2025) — "built by Malawian minds at TNM" with technical
support from strategic partner **[[huawei]]** — bringing faster speeds, an upgraded **TNM SmartApp** and 5G
eSIM, framed against the Malawi 2063 / MIP-1 vision. It also operates the **Mpamba** mobile-money service (see
[[dpi.pay]]). It launched **VoLTE** (5 Mar 2026) and announced plans for a **third data centre** to meet rising
demand (CEO Michel Herbert) — see [[malawi--infra-store]]. Marking **30 years** (Nov 2025), TNM said it covers
**85% of the population** (solar-powered infrastructure for the last 15%) and announced plans for **AI
