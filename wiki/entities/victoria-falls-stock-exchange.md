...
lens: []
entity_type: company
title: Victoria Falls Stock Exchange (VFEX)
places: [ZWE]
...
**Zimbabwe's US-dollar-denominated stock exchange** — it **accepts only US dollars** — and
the intended listing venue for [[econet-infraco]]. One source is held, and it establishes
the exchange only in that role.

## Activity in this wiki

- **Intended venue for the Econet InfraCo listing (as of 2025-12-19).** Econet outlined a
  process for **spinning off its mobile tower and related infrastructure company to unlock
...
trust in banks, drove the [[ecocash]] mobile-money surge recorded on [[ZWE]] — a
hard-currency exchange is the stated mechanism for making a domestic infrastructure asset
investable to foreign capital.
