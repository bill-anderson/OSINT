...
A confederation of **Burkina Faso** ([[BFA]]), **Mali** ([[MLI]]) and **Niger**
([[NER]]), the three military-led Sahelian states that **severed all ties with
[[ecowas]] in 2024**. As a bloc it is an **entity, not a place**. Its digital agenda
is explicitly framed as **Sahelian digital sovereignty** and reduced external
dependence. See [[XWA]], [[gov.regional]], [[sovereignty]], [[colonialism]].
...
- **Niger enrolment began (2026-03-27).** Niger became the second AES state to launch
  ...
  citizens **15 and above** as the main ID document; officials say the paired biometric
  passport meets ICAO standards. Libyan firm **Al Itissan Al-Jadeed** was contracted to
  upgrade Niger's ID cards and passports, and Niger flags plans for a **national data
  centre**, expanded cybersecurity architecture and domestic technical capacity — the
  sovereignty framing. See [[infra.cybersec]], [[infra.store]]. Source:
  [[2026-03-30 Focus on Sahel digital sovereignty gets clearer with Niger's new biometric ID card]].
- **Mali National Tier III data centre (2026-02).** Mali inaugurated a Tier III **National Data
...
- **Burkina Faso Digital Infrastructure Supervision Center (2026-01).** Burkina Faso began building
  ...
  rule in its digital-transformation strategy. Follows its Nov 2025 biometric ID launch. See
  [[infra.store]], [[infra.cybersec]]. Source:
