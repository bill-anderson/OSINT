...
- **[[NER]] Niger — a first national e-Health Master Plan (2026-07).** Niger validated a budgeted **National
  e-Health Master Plan 2025-2029** ([[niger-ehealth-masterplan]]) of **27 structuring projects** — HMIS,
  interoperability, epidemiological surveillance, cybersecurity and data-for-decision — under the junta's
  Refondation programme, explicitly moving "from dispersed projects to a national digital-health policy." A first
  substantive HMIS anchor for a country previously absent from this concept. See [[NER]], [[gov.policy]],
  [[dpi.exchange]]. Source: [[2026-07-09-national-e-health-master-plan-2025-2029-roadmap-lesahel]].
...
- **[[LSO]] Lesotho — foundational-learning dashboard (2026-07).** **[[unicef-lesotho|UNICEF]]** and
  **GPE** are supporting the Ministry of Education and Training to build a **Foundational Literacy and
  Numeracy Dashboard and Scorecards** monitoring Grades 1–3 performance (numeracy, Sesotho, English,
  life skills) for schools, clusters, districts and national policymakers — with tablets to principals
  in **300 project schools**, **solar power in 25 cluster learning spaces**, and data-use
  capacity-building. The familiar EMIS pattern: consolidation for targeting, with the infrastructure
  floor (power) addressed in the same package. See [[LSO]], [[capacity.training]]. Source:
  [[2026-07-23-unicef-gpe-lesotho-learning-dashboard]].
...
which remains the annual school-census tool - DHIS2 is the national **analytical** layer above it. Togo is one of **six** education
  ...
  [[2022-12-01-hisp-wca-dhis2-emis-togo]],
...
- **[[TGO]] Togo — an analytical layer, not a collection layer.** Togo's education MIS is a **[[dhis2]]**
  *analytical* layer added on top of an existing CSPro/**[[stateduc]]** statistical stack, not a replacement
  — StatEduc remains the annual school-census collection tool, so **"national scale" cannot be claimed for
  DHIS2 as the collection layer** (2026-05-04). Milestones: **2019** programme engagement begins
  (corroborated only across the six-country programme, not as a Togo go-live); **2021** StatEduc
  interoperability, the concrete technical milestone; **2024** exam results in a national DHIS2 database.
  The publisher's "currently under review by the Ministry" line dates to the article's **English original of
  2022-12-01** — the held French page is a translation carrying the translation date. Full case:
  **[[togo--dpi-mis]]**.
- **Layered EMIS maturity sits between pilot and embedded.** In Togo, regional level shows "the clearest
  evidence of the system working" — dashboards driving teacher deployment, furniture and school
  construction — while inspection level is "more constrained", the binding constraint being **data
  latency**: validated data reaches DHIS2 weeks after collection and so cannot support in-year decisions
  (2026-05-04). Independently, GPE's ITAP found Togo "cannot yet be said to have a fully accessible,
  operational EMIS", with nothing linking quantitative, financial and qualitative data (2024-04-08).
