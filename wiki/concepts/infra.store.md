...
title: Data Storage
slug: infra.store
places: [MRT, COG, COM, CMR, XGL, XAF, ZAF, NGA, KEN, GAB, EGY, SEN, GHA, NAM, MWI, AGO, TGO, MAR, ETH, TZA, DJI, MOZ, BWA, MLI, NER, BFA, GNQ, UGA, COD, CIV, GIN, XSS, CPV, DZA, SSD, SLE, SOM, TCD, SWZ, MUS]
...
- **Mauritius — an Indian-Ocean data-centre hub with a sovereignty pitch (2025-2026).** Under **Digital
  Mauritius 2030**, the island runs a **10-data-centre** estate across five locations (Tier III/IV; operators
  incl. Aphelion, Rogers Capital, Harel Mallac, Bhumishq, Emtel; the **MIXP** exchange), anchored by
  **[[mauritius-telecom|MT]]**'s **Rose-Belle Tier IV** facility hosting citizen systems (e-Health, government
  portal, **[[mauritius-mobile-id|Mobile ID]]**, government AI) with DR redundancy to the ageing GOC Ébène. A
  2026 *Tech Trends* debate frames **local hosting as legal-clarity-and-control** and pitches Mauritius as a
  regional cloud/cybersecurity hub. Distinct from the mainland power-constrained model — small, dense,
  sovereignty-led. See **[[mauritius--infra-store]]**, [[MUS]], [[infra.connect]]. Sources:
...
- **[[AGO]] Angola — sovereign cloud + a dense commercial estate.** President Lourenço inaugurated the
  **[[data-center-e-cloud-do-governo-angola|Camama national data centre]]** on **28 Apr 2026**
  (6,225 m², **Tier III**, 208 racks/1,040 kW, ~**$89–90m**), base for the **[[nuvem-nacional-de-angola|
  Nuvem Nacional]]** government cloud with **progressive, mandatory** service migration and an explicit
  **document-repatriation** framing. It sits over one of the region's denser commercial clusters —
  [[raxio-group]] (Tier III), [[paratus]] (DC1/2/3, first Tier IV), [[africell]],
  [[angola-cables]]/AngoNAP, [[unitel]] — while [[angola-cables]]'s **Accelera / Clouds2Africa** program
  builds local-currency cloud demand. Localisation as strategy. → [[angola--infra-store]].
...
- **Somalia — data onshoring as declared policy, not yet as fact.** The FGS is building a **National Data
  Center** in Mogadishu (MoCT; under construction from 2023, "nearing completion" as of **2025-05-06**, no
  launch recorded) as the central repository for government-institution data. MoCT's rationale doubles as an
  admission of the status quo: it will "eliminate dependencies of national data on international data storage
  solutions, **that is stored outside the country**" (**2024-04-28**, restated 2025-05-06). Sources:
  [[2024-04-28-moct-national-data-center-tour]], [[2025-05-06-moct-national-data-center-nearing-completion]].
  See [[somalia--infra-connect]].
- **Congo-Brazzaville — the "$13m vs $57m" reading is a currency and scope artefact.** The AfDB puts **some
  €13.8m (≈US$15m)** of the **€66.55m** CAB Congo envelope (€52.47m AfDB + €14.50m government) into building
...
[[XGL]] · [[XAF]] · [[ZAF]] · [[NGA]] · [[KEN]] · [[GAB]] · [[EGY]] · [[SEN]] · [[GHA]] · [[NAM]] · [[MWI]] · [[AGO]] · [[TGO]] · [[MAR]] · [[ETH]] · [[TZA]] · [[DJI]] · [[MOZ]] · [[BWA]] · [[MLI]] · [[NER]] · [[BFA]] · [[GNQ]] · [[MUS]] · [[XSS]] · [[SSD]] · [[SLE]] · [[SOM]] · [[TCD]] · [[SWZ]]
