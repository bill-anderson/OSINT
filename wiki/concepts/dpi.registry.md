...
- **Business registries as a competitiveness race — the incorporation spread (2026-07).** Norebase's
  *State of Expansions in Africa 2026* report (drawing on national registries, government portals
  and legal publications, Jan 2025–mid-2026) puts digital business registration at the centre of
  market-entry competition: incorporation in **24–72 hours in Nigeria and Rwanda** — Nigeria via the
  **Corporate Affairs Commission (CAC)**'s **AI-powered registration portal (2025)** (claimed:
  from ~a week to minutes; 11,000+ registrations processed in a day), Rwanda via the
  **Rwanda Development Board (RDB)**'s fully-online platform (Jan 2026) — against **130+ days in
  Angola** (mandatory notarisation, translation, name publication). Costs spread from **~US$50–800**
  (Rwanda, Nigeria, Kenya) to **US$200,000–1m capital requirements** for foreign investors in Ghana
  (all Jul 2026). See [[NGA]], [[RWA]], [[dpi.govtech]]. Source:
  [[2026-07-22-norebase-state-of-expansions-report]]. *The report document itself is not held as of
  2026-07-23 (no direct URL surfaced; one automated fetch failed) — figures rest on TechCabal's
  account.*
