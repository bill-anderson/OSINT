...
- **[[ZMB]] Zambia — a state-owned rail under the portal (2026-07).** [[smart-zambia-institute]]
  launched **[[govlink|GovLink Private 4G]]** (15 Jul 2026), a **government-owned** network for public
  institutions with health as flagship — the connectivity layer the ZamPortal stack depends on.
  Zambia ranked **130th of 193 on the UN E-Government Development Index (2024)** (**0.5424/1**;
  online-services sub-index **0.4858/1**) — the services score the weaker half. Also **Dec 2025**: a
  decentralised digital-skills programme for government staff. Full thread:
  **[[zambia--dpi-govtech]]**, **[[zambia--infra-connect]]**. See [[infra.connect]],
  [[capacity.training]]. Sources: [[2026-07-17-zambia-govlink-private-4g]],
