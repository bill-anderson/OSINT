...
Lesotho's connectivity story turns on two things: a **Starlink licensing saga** that became a
sovereignty-and-geopolitics flashpoint, and steady **MNO network upgrades** (Econet, Vodacom) racing 5G
and rural coverage — in a market with 100% broadband *coverage* but only ~50% real *usage*.

## Starlink — sovereignty, geopolitics, rural reach

- **Foreign-ownership objection (2025-03).** [[data.satellite]] [[geopol.usa]] The rights group **Section 2**
  opposed Starlink's licence over **100% foreign ownership** — against Lesotho's precedent of Basotho
  participation: **Econet Telecom Lesotho 70/30** (Econet Wireless / government) and **Vodacom Lesotho
  80/20** (Vodacom Group / Sekha-Metsi consortium). Source: [[2025-03-11-starlink-opposition-section2-connectingafrica]].
- **Licence granted amid US-tariff politics (2025-04).** [[gov.legislate]] The **[[lesotho-communications-authority|LCA]]**
  granted Lesotho's **first satellite internet licence** (10-year, 14 Apr) — widely read as a "strategic
  olive branch to Washington" after Trump's **50% tariff** on Lesotho imports. **Vodacom** appealed for
  local shareholding (MD Ralebitso). Source: [[2025-04-22-starlink-licence-mixed-reactions-publiceye]].
- **Launch amid surveillance/sovereignty fears (2025-06/07).** [[sovereignty]] **[[t-connect-lesotho|T-Connect]]**
  (chaired by Nolo Letele) launched Starlink as exclusive reseller, pledging **10,000 direct / 50,000+
  indirect jobs** and disruptive **M10-per-session** pricing — amid public distrust that a "wholly foreign
  entity without a physical address" could enable surveillance (activist Kananelo Boloetse on regulatory
  fairness). Sources: [[2025-06-30-starlink-launch-tconnect-lestimes]], [[2025-07-01-starlink-launch-publiceye]].
- **Rural reach — hotspots, schools, clinics (2025-09 → 2026-01).** [[digital.rural]] [[include.access]]
  T-Connect handed over first **community hotspots** (Matsieng, Thaba Bosiu, Mokhotlong — via principal
  chiefs) and launched **T-Connect Impact** (Starlink Priority Connectivity for schools/clinics) at
