...
entities: [[digital-gabon-project], [in-groupe], [thales], [aninf-gabon]]
...
- **[[in-groupe]]** (French, ex-Imprimerie Nationale) supplies the **physical card and the digital-ID
  management software/hardware** (EVP Yann Haguet); the project launched 25 June 2024.
- **[[thales]]** (French) holds the **historical registry** thread: awarded the biometric national
  registry in **2012**, first cards issued **2013**, then a gap after the Belgian firm **Semlex**'s
  issuance contract was terminated (~2015). Thales is reported to be **resuming its contract** around
  the 2024 relaunch.
- The two vendor roles (card/credential vs registry) are **distinct but under-disambiguated** in the
  secondary coverage — a provenance point to firm up against a primary contract award.

A sovereign national-ID build delivered end-to-end on **French vendor stacks** is the textbook
[[colonialism]] tension set against the government's explicit [[sovereignty]] framing.
...
- **Coverage unknown.** No published NIP/CNIE enrolment figure yet; the World Bank results framework
  targets a "% of population 16+ with a NIP," at baseline as of Dec 2024
  ([[2024-12-19-world-bank-digital-gabon-isr-seq7]]). A dated coverage number is the key gap.
