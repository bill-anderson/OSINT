...
- **Smart ID via banks + ETA at the border (2026-02/03).** Home Affairs
  ...
  **National Population Register** (DHA still custodian) — accelerating the
  ...
  automation as anti-corruption and biometric border control. **Extension — Trusted Employer Scheme
  Phase II (gazetted 2026-07-21):** DHA widened employer-accredited immigration to **strategic
  infrastructure projects**, **regional/global headquarters** and **qualifying financial-sector
  entities**, on a **risk-based** model requiring meaningful investment, predominantly
  citizen/permanent-resident employment, skills-development investment and priority-sector operation,
  assessed by an **interdepartmental committee**; **EOIs 2026-07-20 → 2026-09-04**. It launches on a
  **separate online portal** that will "ultimately be integrated" into the ETA — a parallel channel
  ahead of the consolidation the ETA was created to deliver, with **no integration date, cost,
  accreditation volume or Phase I evaluation established as of 2026-07-21**. See [[dpi.govtech]],
  [[dpi.registry]], [[gov.protect]], [[sa-digital-id-regulations]]. Sources:
