---
type: intersection
title: Uganda × Connectivity & Network Control
place: UGA
topic: infra.connect
places: [UGA]
...
Uganda's connectivity story has two faces that this page holds together: **abundant new capacity** — fibre
superhighways, gigabit broadband, a planned regional satellite — and a **state that treats the network as a
lever to control**, from licensing crackdowns and heavy taxes to the four-day election shutdown (below). The
pipes are being laid faster than ever; who may switch them on, and at what price, is the contested part.

## Fibre superhighways

- **Bayobab Kampala–Malaba (May 2025).** [[bayobab]] (MTN Group) lit a **260 km** rail-based fibre route to
  the Kenyan border — the **shortest link Kampala→Mombasa** subsea landings, **>1 Tbit/s**, completing the
  East African backbone. Source: [[2025-05-06-kampala-malaba-fibre-route-bayobab]].
- **Paratus G2M (Feb 2026).** [[paratus-group]] switched on a **2,000 km Goma–Mombasa** protected route via
  Kigali, Kampala and Nairobi (Uganda partner Roke Telekom) — inland markets to coastal subsea capacity,
  complementing its LEO footprint. Source: [[2026-02-09-paratus-goma-mombasa-g2m-fibre-route]].
- **CSquared's open-access model (Aug 2025).** **[[csquared]]** — **founded in Uganda in 2011** (from
  Google's Project Link, spun off 2017) — is betting **$125m** on carrier-neutral wholesale "superhighways";
  **7,500+ km across six countries**, 100+ ISPs. Uganda is its home base. Source:
  [[2025-08-21-csquared-125m-fibre-superhighways]].
- **Gigabit at the edge (May 2026).** **[[savanna-fibre-uganda]]** launched **1 Gbps** fixed broadband.
  Source: [[2026-05-04-savanna-fibre-uganda-1gbps-broadband]].

## Satellite sovereignty

- **Northern Corridor regional satellite (May 2026).** Kenya, South Sudan, **Uganda** and Rwanda agreed to
  advance the **NCRCBSI** — a regional communications/broadcasting satellite explicitly **to reduce reliance
  on external satellite systems and international routes** — starting with a shared-funded feasibility study
  (Uganda's ICT Minister Chris Baryomunsi at Connected Africa Summit 2026). A sovereignty-of-orbit play
  running alongside the Starlink question below. See [[data.satellite]], [[gov.regional]]. Source:
  [[2026-05-04-east-africa-regional-satellite-ncrcbsi]].

## Access, and the network as public infrastructure

- **Border free Wi-Fi (Jul 2025).** [[nita-uganda|NITA-U]] launched free public Wi-Fi at **Bwera/Mpondwe**
  on the porous DRC border (ADF-affected) under the **Uganda Digital Acceleration Project (UDAP)** — framed
  for trade, e-services and **security reporting** (and, tellingly, minister Kabbyanga's warning about the
...
- **Telecom tax as a brake (Jun 2026).** A UCC-commissioned study called Uganda's telecom tax **"among the
  most burdensome in East Africa"** — **12% excise on data, 18% VAT, up-to-0.5% MoMo-withdrawal charge**,
  ICT import duties — proposing cuts (excise 12%→5%, VAT 18%→14%), duty relief on entry-level 4G/5G phones,
  reclassifying **internet access as an essential public service**, and rural capex incentives. See
  [[gov.policy]], [[dpi.pay]]. Source: [[2026-06-22-ucc-proposes-major-telecom-tax-cuts]].
- **Wi-Fi enforcement (Jul 2026).** UCC began a **nationwide crackdown on unlicensed public Wi-Fi** under
  the Uganda Communications Act — pitched on consumer/cybersecurity grounds, but also an assertion of
  licensing control over who provides connectivity. See [[gov.legislate]]. Source:
  [[2026-07-08-ucc-enforcement-against-illegal-public-wifi]].

## Reads

- `sovereignty`: Uganda is simultaneously **liberalising the supply of bandwidth** (open-access fibre, new
  ISPs, a regional satellite to escape foreign LEO dependence) and **tightening the state's hand on the tap**
  (punitive taxes the UCC itself now wants cut, licensing enforcement, and — see below — the power to switch
  the whole network off). The capacity is genuinely improving; the political-economy question is whether
