...
Small East-African state whose outsized role is as a **submarine-cable and data-residency
hub** — the "digital switchboard" where Red Sea / Indian Ocean cable systems land. Now
layering a **national AI / Smart-Nation ambition** ([[vision-djibouti-2035]]) on top of that
transit position.
...
- **2026-02-09** — **Mobile ID national digital identity platform launched.** President Guelleh
  ...
  banking), with planned cross-database interoperability. Biometric data stored **exclusively by
...
- **2025-06-30** — **First comprehensive Digital Code adopted.** [[djibouti-digital-code]] (eight
  volumes, ~800 articles) — data protection (156-article regime creating the **[[cndp-djibouti|CNDP]]**),
  cybersecurity and e-commerce. See [[gov.protect]], [[djibouti--gov-protect]]. Source:
  [[2025-07-01 Djibouti Digital Code adopted by National Assembly]].
- **2024-11-25** — **Wingu TO7 Tier-3 data centre + cable landing station inaugurated.** See
  [[infra.store]], [[djibouti--infra-store]]. Source:
  [[2024-11-25 Djibouti inaugurates Wingu TO7 Tier-3 data centre and cable landing station]].
- **2024-05** — **PAIX–Sovereign Fund JIB1 data-centre JV** (~$50m, first phase 2026). See
  [[paix-data-centres]], [[djibouti--infra-store]]. Source:
  [[2024-05-15 PAIX-Djibouti Sovereign Fund data centre joint venture (JIB1)]].
- **2026-07-13** — **WSIS-2026 partnership drive; first national AI strategy in train.** On the
  sidelines of **WSIS 2026** (Geneva, 6–10 Jul), communications minister Mohamed Abdoulkader
  Moussa Helem sought support from the **[[itu]]** (SG Doreen Bogdan-Martin; BDT Director Cosmas
  Zavazava) and **[[smart-africa]]** (CEO Lacina Koné) — plus Chinese authorities — to digitalise
  public services, build AI capacity and close the **urban–rural digital divide**. Talks with
  Smart Africa covered aligning national projects (the **Djibouti Digital Foundation, DFN**) with
  the **[[eardip]]** regional integration project and continental data-sovereignty/AI work.
  Djibouti's **first national AI strategy** (launched Jan 2026 with ESCWA + UNESCO) sits under
  **[[vision-djibouti-2035]]** and its "Smart Nation" goal; the country joined the **AI for Good
  Summit** alongside WSIS. Source:
  [[2026-07-13 Djibouti Seeks ITU, Smart Africa Support for Telecoms and AI Development]]. See
  [[tech.ai]], [[gov.policy]], [[gov.regional]], [[infra.connect]], [[include.divides]], [[XEA]].
- **Connectivity baseline (DataReportal, end-2025).** ~**772,000** internet users (**65%**
  penetration); **616,000** active mobile connections, **>92%** on mobile broadband; the country
  operates **three data centres** and an **Internet Exchange Point (IXP)**. See [[infra.connect]],
  [[infra.store]].

### Standing profile

- **East Africa's "digital switchboard."** Djibouti's concentration of cable landings (among
  the region's highest) positions it as the interconnection point for East-African traffic —
  cited alongside **[[ETH]]** and **[[SOM]]** as an emerging digital force. See
  [[infra.connect]], [[XEA]].
- **One of the continent's five cable hubs.** Djibouti sits with **[[EGY]], [[ZAF]], [[NGA]],
  [[KEN]]** as a landing concentration through which much of Africa's international bandwidth
  flows. See [[infra.connect]].
- **Data-residency storage market.** Referenced as a data-centre / residency destination for
