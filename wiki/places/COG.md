---
type: place
title: Congo (Republic of / Brazzaville)
code: COG
parent: XCA
place_kind: country
...
An oil-dependent Central-African state building DPI on **World Bank (PATN) and AfDB** financing, with a
notably **sovereignty-framed** agenda: local data centres to end reliance on European servers, a universal
biometric ID grown from a tax number (NIU), and a data-protection commission stood up alongside. The pieces
are arriving, though GSMA flags weak connectivity (18.8% unique mobile-internet use) and heavy taxes as the brake.

## Recent developments

- **2026-01-22** — **National Personal Data Protection Commission established.**
  Congo-Brazzaville stood up the **[[national-personal-data-protection-commission-congo]]**,
  with ICT minister **Léon Juste Ibombo** installing members to consolidate the
  country's "digital rule of law" amid rapid digitisation of public services and
  the digital economy. The commission is an **independent authority** empowered to
  advise, warn and **sanction**, and tasked with instilling a data-protection
  culture across the public sector, business and civil society while balancing
  innovation with rights. Source:
  [[2026-01-22 Congo-Brazzaville intros data protection commission]].
  See [[gov.protect]], [[gov.legislate]].

- **2025-10-23** — **NIU biometric unique-ID relaunched.** Congo relaunched production of the **[[niu-congo]]**
  — a tax number turned **universal biometric foundational ID** (from age 6, free, mandatory for banking,
  utilities, tax, nationality/criminal-record certificates, social security). → [[congo--dpi-id]]. Source: [[2025-10-23 Congo relaunches NIU biometric unique-ID card production]].
- **2025-07-16** — **National digital-identity workshop.** Minister [[patn-congo|Ibombo]] pushed a secure,
  sovereign digital-identity system + a Digital Wallet (World Bank PATN); civil-status reform via **SIFEC**;
  Thales cited as partner. → [[congo--dpi-id]]. Source: [[2025-07-17 Congo - national workshop launches secure digital-identity system push]].
- **2025-03** — **Passport + national-ID production centre, Pointe-Noire** (300 CEMAC passports + 20,000 CNI/day)
  — decentralising issuance from Brazzaville. See [[dpi.id]]. Source: [[2025-03-04 Congo - passport and national-ID production centre set up in Pointe-Noire]].
...
**Non-state** — US$506m committed across 9 deals (2016–2025). (2 further deals carry only a non-USD amount, not summed.) Top financiers: Export-Import Bank of China (US$264m); World Bank (US$100m); African Development Bank (AfDB) — Digital and Creative Economy (US$60m).
...
- **Digital identity** → **[[congo--dpi-id]]**. The **[[niu-congo]]** tax-number-turned-universal-biometric-ID;
  a WB-PATN digital-ID framework + Digital Wallet + SIFEC civil-status digitisation; decentralised passport/ID production.
- **Data centres / sovereignty** ([[infra.store]]) — the **[[congo-national-data-centre]]** (Brazzaville, CAB, "first in
  Central Africa") + the **[[arpce-congo]]** Pointe-Noire (2Africa) DC.
