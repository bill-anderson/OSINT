...
- **2026-07-11** — **UXP/X-Road data-exchange dashboard at scale.** Benin's national
  ...
  **176 information systems** and **512 services**. Top service providers are **ANATT**
...
- **2026-05-16** — **APDP as a working data-protection authority.** At the ID4Africa 2026
  ...
  limitations on data processing, and uses a government liaison to bridge the DPA and the
  rest of government (e.g. stripping extraneous fields from the electoral roll before
  publication to make it compliant). Source:
  [[2026-05-16 World Bank, African DPAs outline formula for trusted digital identity, DPI]].
  See [[gov.protect]], [[dpi.id]].
- **2026-04-27** — **SADX Technical Assessment Mission member.** Benin joined Rwanda and
  Ghana in Kigali for a **[[smart-africa]]** Data Exchange (**[[sadx]]**) technical mission —
  identification authorities, immigration and ICT institutions working through PKI trust
  chains, API contracts, cross-border verification-request processing and incident response
  for a "functional, federated and decentralised" cross-border architecture. Source:
...
- **2026-03-16** — **WARDIP2: $137m for Benin + Liberia + Sierra Leone.** The World Bank
  approved **$137m** (announced 2026-03-11) for the second phase of the **Western Africa
  Regional Digital Integration Program** (**[[wardip]]**): broadband for **>5m** people and
  digital public services for **>5m** more (~10.6m total) across the three ECOWAS states, on
  three pillars (infrastructure / data-centre capacity, business environment, cross-border
  services) with WAEMU regulatory harmonisation. WARDIP launched 2023 (also Gambia,
  Guinea-Bissau, Mauritania), with [[ecowas]], [[african-union]] and [[smart-africa]]. Source:
  [[2026-03-16 New $137M initiative to enable digital service access for millions in three ECOWAS nations]].
  See [[infra.connect]], [[dpi.govtech]], [[finance.new]], [[gov.regional]], [[XWA]].
- **2026-03-11** — **NSOs as data custodians (RIA report).** [[research-ict-africa]] published
  a report on the evolving role of National Statistics Offices, naming **Benin among four NSO
  case studies** (ZAF/GHA/KEN/BEN) being displaced as primary data producers by platform,
  satellite and privately held digital data; it recommends legal reform to formalise the NSO
...
- **2026-02-02** — **75% of ID services now accessed digitally.** [[anip-benin]] reported that
  ...
  ANIP BJ app / 8% USSD), **3.8m** telecom authentications and **25m** eKYC verifications. A new
  digital civil-registration system (birth certificate + PIN issued at birth; pilot Oct 2025,
  UNICEF + WURI) feeds the pipeline. Source:
  [[2026-02-02 Benin reports 75% of identification services accessed through digital platforms]].
  See [[dpi.id]], [[dpi.govtech]], [[data.statistics]], [[include.access]].
- **2026-01-27** — **Cybastion to wire SECUROUTE into the interoperability layer.** [[cybastion]]
  is partnering with Benin's Ministry of Economy & Finance to extend digital infrastructure for
  full interoperability with **[[securoute]]**, the national road-enforcement data platform
  (built with the Ministry of Transport, National Police and road-safety agencies) that
  centralises and secures traffic-enforcement data across government systems. Cybastion's govtech
  portfolio spans e-payments, eTax, eVisa and eHealth. Source:
  [[2026-01-27 Cybastion Advances Digital Government Solutions, Supports Benin's SECUROUTE Infrastructure Upgrade]].
  See [[dpi.govtech]], [[infra.cybersec]], [[dpi.exchange]], [[gov.standards]].
- **2025-12-18** *(launched 2025-10-24)* — **ePass diaspora passport-renewal app, built by
  Seamfix.** Benin launched **[[epass-benin]]** (epass.gouv.bj, Oct 2025) letting citizens abroad
  renew passports without an embassy visit — contactless fingerprint + face, ICAO-compliant,
  4-week delivery (≈15-min submission), registration via national digital ID + consular number;
  part of "4D Diplomacy." Revealed 2025-12-18 as developed by **[[seamfix]]** (Nigeria/UK) on its
  **GovSmart** platform, integrated with Benin's national ID and immigration systems; now in 80+
  countries. Sources:
...
- **2025-11-01** — **Foundational digital ID (fID / "C'est moi") reaches ~99%.** A World Bank
  ...
  37%), through 2017-18 biometric enrolment of ~90%, WURI added **2.2m** more enrolments (4,000
  abroad) to bring biometric coverage to **near-99%**. The QR-code "Certificat NPI/fID" ("C'est
  moi") is free and lifelong, carried on a mobile app and linked to services including the Alafia
  microcredit programme; delivered with [[world-bank]] and [[ecowas]]. Sources:
  ...
  See [[dpi.id]], [[dpi.registry]], [[include.access]], [[include.divides]].
- **2025-09-01** — **Three cooperation deals at the 5th Cyber Africa Forum (Cotonou).**
  [[asin-benin]] (DG Marc-André Loko) signed agreements with IIDiA (modernise national
  information systems), Quality Corporate (e-signatures / seals / digital ID) and Orbus Digital
  Services (PKI software for e-gov), and released Benin's **maiden national cybersecurity report
...
- **2025-06-23** — **DPI at scale: 1,500+ services, 70m+ transactions (CDPI webinar).** In a
  ...
  commercial product, **not** X-Road) with **1,500+** services integrated, **55+** institutions,
  **300+** services fully digitized and **70m+** data-exchange transactions, plus a citizen portal
  (200+ services), national PKI and a mobile-money payments platform. Foreign partners must work
  through a local company. [[gates-foundation]] / [[mosip]] framing on open DPI. Source:
  [[2025-06-23 Benin shares its X-Road-inspired DPI interoperability experience in peer learning webinar]].
  See [[dpi.exchange]], [[dpi.govtech]], [[dpi.pay]].
- **2025-06-18** — **Mobile wallet planned; ANIP register at ~98%.** At ID4Africa 2025
  ([[id4africa]]), [[anip-benin]] DG Aristide Guy Adjinacou said Benin plans a citizen **mobile
  wallet** by ~end-2026 as the missing module of its digital-ID stack. Post-2017 Identification
  Law figures: national register at **~98%** of population, **10m+** documents issued, **~200,000**
  biometric authentications/day, connected to **80+** institutions; AI used for satisfaction
...
- **2024-10-28** — **2,050 biometric CRVS terminals from the World Bank.** [[world-bank]] donated
  ...
  placed Benin among 13 SSA countries with <70% ID access. Source:
...
**Domestic state** — 1 budget line held (national; first capture 2026-07-22). FY2026: FCFA 12.3bn proposed. Amounts in the announcing state's own currency; stages as stated, never merged; no cross-year USD summation.
