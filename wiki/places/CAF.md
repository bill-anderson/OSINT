...
A **fragile, landlocked, low-connectivity state rebuilding its digital and identity
foundations from near-collapse.** The 2013 crisis destroyed 60–80% of identity documents;
~90% of the population is offline and only ~14% has electricity. Yet since 2024 CAR has moved
on several fronts at once — a first 4G licence, three e-government platforms, biometric voter
registration, and a modern (if unenforced) data-protection law — mostly donor-driven, under
President **[[faustin-archange-touadera]]**'s PND 2024-2028 digital agenda. The through-line is
**sovereignty anxiety**: foreign vendors and foreign disinformation on one side, a state
struggling to reach its own territory on the other.
...
- **2025-12-12** — **"Gouvernemental Centralisé"** unified public-services portal launched
  (10 Dec), World Bank / EY Tunisie Medianet. [[caf--dpi-govtech]]. Source:
...
- **2025-05-22** — Touadera frames **digital transformation** as an economic-revival strategy.
  Source: [[2025-05-22 RCA - Touadera mise sur la transformation numerique pour revitaliser l'economie]].
- **2025-03-25** — **e-Tax** online tax platform launched (DGID). [[caf--dpi-govtech]]. Source:
  [[2025-03-25 La Centrafrique lance officiellement e-Tax, sa plateforme de paiement d'impots en ligne]].
- **2024-11-11** — **[[orange-centrafrique]]** wins CAR's **first 4G licence**. [[caf--infra-connect]].
  Source: [[2024-11-11 Orange secures 4G license in Central African Republic]].
- **2024-10 → 12** — **Biometric voter registration** ([[genkey]], [[ane-central-african-republic]],
  [[undp]]) ahead of the first local elections in ~36 years. [[caf--dpi-id]]. Sources:
