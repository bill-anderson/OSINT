...
Post-2023-transition Gabon (President **Brice Clotaire Oligui Nguema**; Digital Economy Minister
**Mark-Alexandre Doumba**) is pursuing a broad, World Bank–anchored digital-transformation programme:
a relaunched national e-ID, a public-finance and payments digitalisation stack, social/land registries,
and a sharply increased digital budget — framed throughout as **digital sovereignty**, but delivered
substantially on foreign finance and vendors, and dogged by slow disbursement and execution.
...
- **2026-01-15** — Launches **[[sigfip-gabon]]** (Integrated Public Finance Management System),
  consolidating all state tax/customs/non-tax revenue and spending on one treasury-connected platform.
  Sources: [[2026-01-18-gabon-sigfip-public-finance-platform-launch]],
  [[2026-01-14-gabon-public-finance-egov-initiatives]].
- **2025-12-23** — Signs a digital-transformation **MoU with [[huawei]]** ([[gabon-huawei-mou]]): joint
  project committee, startup integration, skills transfer.
- **2025-12-09** — Launches **[[madigipaie-gabon]]** public digital-payments programme with
  **[[beac]]**/GIMAC (mobile-money payment via GIMACPAY QR; >1,000 codes deployed). Source:
  [[2025-12-11-gabon-madigipaie-digital-payments-launch]].
- **2025-12-08** — **[[uncdf]] financial-inclusion partnership** ([[gabon-uncdf-financial-inclusion-deal]]);
  ~54% of adults unbanked (Findex 2025). Source: [[2025-12-12-gabon-uncdf-financial-inclusion-deal]].
- **2025-11-24** — Engages French **[[ign-fi]]** on **cadastre modernisation**
  ([[gabon-ign-fi-cadastre-deal]]). Source: [[2025-11-24-gabon-cadastre-modernization-ign-fi]].
- **2025-10-19** — **2026 digital budget of 82bn CFA, +156.2%** on 2025; data-centre, fibre, 5G and
  submarine-cable plans; digital-sovereignty ordinance. Source:
  [[2025-10-24-gabon-2026-digital-budget-156pct]].
- **2025-09-05** — Prioritises **revenue digitalisation** to fund a ~$13bn 2026 budget (informal
  economy 40-50% of GDP). Source: [[2025-09-15-gabon-2026-budget-revenue-digitalization]].
- **2025-08-28** — Finalises the **[[registre-social-unique-gabon]]** (Unique Social Registry). Source:
  [[2025-08-28-gabon-registre-social-unique]].
- **2025-08-18** — DGI launches the **e-tax** portal ([[digitax-gabon]]). Source:
  [[2025-08-18-gabon-etax-dgi-portal-launch]].
- **2025-05** — Concludes a **[[visa]]** financial-inclusion partnership (Africa CEO Forum,
  Côte d'Ivoire) — [[gabon-visa-partnership-deal]] (reported second-hand).
- **2025-02** — Ministry of Justice roundtable on **standardised custody registers** and their
  digitalisation (Méndez Principles). Source:
  [[2025-02-01-gabon-custody-registers-judicial-safeguards]].
- **2024-06-25** — Launches the **CNIE** electronic national ID after an ~11-year gap (see
  [[gabon--dpi-id]]).
...
**Non-state** — US$460m committed across 7 deals (2016–2024). Top financiers: Huawei (US$234m), World Bank (US$198m), MIGA (Multilateral Investment Guarantee Agency) (US$28m). Leading subjects: `dpi.govtech`, `infra.connect`, `gov.policy`.
...
**[[sigfip-gabon]]** (treasury/PFM), and **[[madigipaie-gabon]]** (public payments via BEAC/GIMACPAY).
Reinforced by the [[uncdf]] and [[visa]] financial-inclusion partnerships. Mobile money: 4.5m accounts
end-2024 (only 1.6m active); 368.3m transactions worth CFA4,087bn in 2024.

### Registries & social protection — [[dpi.registry]] · [[include.access]]
The **[[registre-social-unique-gabon]]** social registry (ANINF + World Bank), the **[[ign-fi]]**
cadastre-modernisation engagement, and the digitalisation of judicial **custody registers**.

### Sectoral MIS — [[dpi.mis]]
The education MIS **[[sige-gabon]]** (SIGE), with World Bank tablets and integration of school-health
indicators.
