...
A more substantive pending decision is the designation of the USS provider – the entity that will operate the database in practice. The regulations are silent on who that will be, but the CSIR is the obvious candidate given the technology dependency. –
