...
Somalia has an economy that heavily relies on mobile money transactions
Somalia's government has told the BBC it is concerned about WhatsApp's plan to launch a new feature that would let people chat using usernames rather than phone numbers, saying it could pose a security risk.
