...
# Téléphonie mobile : la GSMA publie son rapport sur le Congo

*Les Dépêches de Brazzaville / adiac-congo.com — Vendredi 26 Juin 2026 - 9:24. Par Guillaume Ondze.*

Global system for mobile communication association (GSMA), autrement dit l'Association du système mondial de communications mobiles, a publié, le 22 juin à Brazzaville, son rapport sur les réformes numériques qui pourraient libérer 870 milliards FCFA et connecter plus de 504 000 personnes supplémentaires en République du Congo d'ici à 2030.
...
**Sweep note (not part of the source):** This is the **local launch coverage of the GSMA study the wiki already holds** as `raw/2026-01-01 Driving Digital Transformation of the Economy in the Republic of Congo.md`, which carries `published: 2026-01-01` with `date_precision: year` and `date_source: proxy`. This article dates the report's publication to **22 June 2026** at the GSMA Digital Africa Summit in Brazzaville — i.e. it **re-dates the held source from a padded proxy year to a real day**. Not a duplicate (different outlet, and the held item is the GSMA press release itself). Note the article's internal inconsistency: "504 000" in the lede vs "540 000" later; the held GSMA press-release title says 540,000.
