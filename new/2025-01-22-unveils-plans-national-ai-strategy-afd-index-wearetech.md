...
<!-- Byline and date established from the fetched page, which carries an in-body line
     "By : Samira Njoya / Date : mercredi, 22 janvier 2025 09:30". Agrees with Exa metadata. -->

<!-- Note for ingest: **the earliest point on the SNIA timeline in the whole CMR corpus** —
     six months before the July 2025 consultations. At this date the strategy is only
     "under development" and announced at the 2025 sectoral roadmap consultations; there are
     no targets yet. Useful as the dated origin of the thread the staged 2025-07-08 items
     pick up.

     Carries a dated external benchmark worth capturing: **Cameroon scores 30/100 on the AFD's
     AI Investment Potential Index (as of Jan 2025)**, level with Angola, Guinea, Ethiopia and
     Burkina Faso. The AFD report ("AI Investment Potential Index: Mapping Global Opportunities
     for Sustainable Development") is a reference study — capture it as an `instrument` or
     `resource` entity and cite the score rather than promoting it as current state
     (Currency discipline → Reference studies: cite, don't absorb). -->

# Cameroon Unveils Plans for National Artificial Intelligence Strategy

*By: Samira Njoya — Date: mercredi, 22 janvier 2025 09:30*
...
By Samira Njoya, Editing by Sèna D. B. de Sodji
