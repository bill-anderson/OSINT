---
type: source
title: "Révision budgétaire 2024-2025 : des imprévus majeurs en ligne de mire"
url: https://www.iwacu-burundi.org/revision-budgetaire-2024-2025-des-imprevus-majeurs-en-ligne-de-mire/
publisher: IWACU
published: 2024-12-24
date_precision: day
date_source: proxy
places: [BDI]
topics: [finance.budget, dpi.pay]
entities: [[ministere-des-finances-du-budget-et-de-leconomie-numerique-burundi], [office-burundais-des-recettes]]
lens: []
...
# Révision budgétaire 2024-2025 : des imprévus majeurs en ligne de mire

*Par Stine Akimana, IWACU.*
...
Cette nouvelle approche vise à optimiser les ressources disponibles et à réduire les dépenses superflues, tout en garantissant que les missions essentielles soient réalisées. Après analyse, débat et échanges approfondis sur le projet, les députés l'ont adopté à l'unanimité.

---

**Sweep note (not part of the source).** IWACU does not expose a publication date on
this page; `published` is the **event date** — the Assembly plenary that adopted the
loi de finances rectificative FY2024/25, 24 December 2024 — hence
`date_source: proxy`. The payload for this dataset is the electronic-invoicing
machines: **500 of 10 000 delivered**, given by the minister as a cause of the
revenue shortfall that forced the rectificative (Loi n°1/27 du 30 décembre 2024,
staged at `new-budget/BDI/2024/`). Procurement cost of the machines is not stated.
