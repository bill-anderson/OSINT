---
type: source
title: Los diputados ratifican convenios internacionales para reforzar la ciberseguridad y la mediación en Guinea Ecuatorial
url: https://realequatorialguinea.com/destacado/politica/los-diputados-ratifican-convenios-internacionales-para-reforzar-la-ciberseguridad-y-la-mediacion-en-guinea-ecuatorial/
...
[CLIP — full article text captured at search time.] Significant: GNQ ratifies the AU Malabo Convention — the treaty was itself adopted in Malabo in 2014 but had not been ratified by the host state until now. Ties to Ley 7/2024 (cybercrime law) and the ANCIC. GNQ also has a pre-existing **Ley 1/2016 de Protección de Datos Personales** (data-protection law with a designated authority — see manifest note).
