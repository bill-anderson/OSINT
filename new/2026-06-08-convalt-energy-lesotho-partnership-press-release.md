...
url: https://convalt.com/press_releases
publisher: Convalt Energy, Inc.
published: 2026-06-08
date_precision: day
date_source: source
---

> **Capture note (not part of the source):** Convalt Energy publishes its releases on a single
> rolling `press_releases` listing page rather than at per-release permalinks; the URL above is the
> canonical location at which this release was published and retrieved (2026-07-20). The body below
> is the **complete verbatim text of the 8 June 2026 Lesotho release** as carried on that page,
> including its subheading and forward-looking-statements notice. Other releases on the same listing
> page (e.g. the 16 June 2026 Gallup Land Partners release) are not reproduced here.
