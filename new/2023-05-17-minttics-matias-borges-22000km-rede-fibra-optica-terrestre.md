---
title: "MATIAS BORGES: \"DOIS NOVOS PROJECTOS VÃO GARANTIR A EXPANSÃO DOS SERVIÇOS DE COMUNICAÇÕES NOS MUNICÍPIOS E NAS COMUNAS\""
url: https://minttics.gov.ao/ao/noticias/matias-borges-dois-novos-projectos-vao-garantir-a-expansao-dos-servicos-de-comunicacoes-nos-municipios-e-nas-comunas/
publisher: MINTTICS — Ministério das Telecomunicações, Tecnologias de Informação e Comunicação Social (Angola)
published: 2023-05-17
date_precision: day
date_source: source
---

<!-- Note on dating: the ministry page carries no visible on-page date. 2023-05-17 comes from
the publisher's page metadata and is corroborated by the article's own framing — an interview
given to Jornal de Angola "no âmbito do Dia Mundial das Telecomunicações" (World Telecommunications
Day, 17 May). Originally published by Jornal de Angola and republished by MINTTICS on its own site. -->

MATIAS BORGES : "DOIS NOVOS PROJECTOS VÃO GARANTIR A EXPANSÃO DOS SERVIÇOS DE COMUNICAÇÕES NOS MUNICÍPIOS E NAS COMUNAS"
