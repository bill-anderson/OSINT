---
type: source
title: "Identité numérique et Mobile ID, une avancée stratégique vers l'administration de demain"
url: https://www.lanation.dj/identite-numerique-et-mobile-id-une-avancee-strategique-vers-ladministration-de-demain/
...
# Identité numérique et Mobile ID, une avancée stratégique vers l'administration de demain

*Date note: body reads "Organisé hier au Palais du peuple", so the forum fell the day BEFORE publication. Exa metadata gives publication 2026-02-09 → forum 2026-02-08. **This may re-date held wiki material**: `wiki/places/DJI.md` records the Mobile ID launch as 2026-02-09, sourced from Biometric Update (published 2026-02-10). The local outlet places the launch event a day earlier. Not resolved here — flagged for ingest adjudication. Page chrome renders a cached clock date ("Monday, June 15, 2026") which is NOT the publication date.*
...
S'exprimant devant les participants, le ministre de l'Intérieur, M. Said Nouh Hassan, a tenu à préciser les contours et les enjeux du Mobile ID, tout en rassurant les citoyens sur les questions sensibles liées à la protection des données personnelles. Il
