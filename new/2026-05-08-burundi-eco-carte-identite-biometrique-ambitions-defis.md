---
type: source
title: "La carte d'identité biométrique en marche, entre ambitions et défis"
url: https://burundi-eco.com/la-carte-didentite-biometrique-en-marche-entre-ambitions-et-defis/
...
*Par Gilbert Nkurunziza, Burundi Eco, 8 mai 2026.*
...
**Sweep note (not part of the source).** Caught by the FY2024/25 run's blocks 4–7
date window (2024-01-01 → 2026-06-30). **Origin is unresolved and matters:** the
~15 milliards BIF is stated as a *whole project cost*, not an appropriation, and
the identity workstream has been carried by the World-Bank-financed PAFEN
(P176396) since 2022 — so the fisc share is not established here. Compare the
minister's later statement (`2026-06-12`, Burundi Eco) putting **16 milliards BIF in
the FY2026/27 budget bill** for the same initiative: that is the appropriated
counterpart and the figure a domestic-state record would key on.
