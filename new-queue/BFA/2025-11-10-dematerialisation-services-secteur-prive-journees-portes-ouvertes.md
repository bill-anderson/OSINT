...
places: [BFA]
topics: [dpi.govtech, capacity.training, tech.industry, include.access]
entities: [[cci-bf], [direction-generale-des-impots-burkina-faso]]
---

# Dématérialisation des services: le secteur privé s’approprie les procédures

*Une visite guidée dans les stands d’exposition des journées portes ouvertes sur les procédures de dématérialisation.*
