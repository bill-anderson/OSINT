...
places: [BEN, SEN, TGO]
topics: [gov.regional, infra.connect, include.access, gov.legislate]
entities: [[arcep-benin], [artp-senegal], [arcep-togo], [ecowas]]
---

<!-- Provenance note: Tech Review Africa is a byline-free PR wire (README source table). Published date established from the page's own "Date:" line at fetch time — Exa served no date. Sourcing the underlying ARCEP Benin / ARTP Senegal statements would be preferable at ingest. -->
