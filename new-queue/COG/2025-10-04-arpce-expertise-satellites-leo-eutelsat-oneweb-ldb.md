...
# Communications électroniques : l'ARPCE renforce son expertise sur les satellites de télécommunications

*Les Dépêches de Brazzaville / adiac-congo.com — Samedi 4 Octobre 2025 - 13:00. Par Quentin Loubou.*
...
*Légendes et crédits photo : Benjamin Mouandza et Serge Abel Ongani (au centre) sur le site du téléport de Rambouillet dans les Yvelines / DR*

---

**Sweep note (not part of the source):** The clearest **satellite/LEO** signal for COG in the window, and notably it runs toward **Eutelsat/OneWeb (EU)** rather than Starlink — the sweep found **no Starlink licensing story for Congo-Brazzaville at all**, which is itself informative given Starlink's spread across the region. Tagged `geopol.eu`. Pairs with the 2026-04-09 ARPCE item, which confirms experimental satellite terminals require express ARPCE authorisation.
