...
Date: 2026-06-21. By: Kanto Kai Okanta.

*Sweep note — PR-wire: Tech Review Africa serves no date to search; the body carries `Date: 2026-06-21` and a named byline. The item reads as Congo Telecom corporate communications. The **primary worth sourcing at ingest** is Congo Telecom's own release or the AfDB Annual Meetings (Brazzaville) session record for the "Building resilient energy, transport and digital infrastructure for regional integration" conference.*

*COD/COG note: this piece names Orange DRC, Airtel and Vodacom Congo, but the subject is **Congo Telecom (COG)** courting DRC operators. Correctly filed to COG; COD tagged as the counterparty.*
