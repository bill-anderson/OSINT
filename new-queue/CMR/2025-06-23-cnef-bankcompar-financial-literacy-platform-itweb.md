...
<!-- Note for ingest: a state-built **price-transparency data platform** (BankCompar, launched
     20 Jun 2025 by the National Economic and Financial Committee) — govtech aimed at the banks
     rather than at citizens' paperwork, which is a different shape from the rest of the CMR
     govtech holdings. Roadmap facts worth dating: extension to microfinance and insurance
     "beginning next year" (i.e. 2026) pending service-label standardisation, and a savings
     interest simulator due end-2025. Both are forward commitments as of Jun 2025 — check
     whether they landed before treating them as current state. -->

# Cameroon boosts financial literacy with new digital platform

*By Amindeh Blaise Atabong, Contributing journalist, Johannesburg — 23 Jun 2025*
