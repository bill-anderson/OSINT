...
entities: [[liquid-intelligent-technologies], [eutelsat-oneweb]]
---
...
<!-- CAPTURE NOTE: mmegi.bw serves only the lede and opening paragraphs to unauthenticated fetch. Text above is the complete free-to-read body as captured 2026-07-17. ADMISSIBILITY FLAG: reads as vendor-supplied thought-leadership (Liquid Intelligent Technologies) placed as a Mmegi feature — treat as an announcement record and prefer a primary or better-sourced account if the same claim is needed. -->
