...
<!-- Byline note: Exa metadata attributed this to "Jennifer Onyeagoro"; the fetched page
     reads "Author: Joyce Onyeagoro". The page byline is used. -->

<!-- Note for ingest: this is a secondary account of a primary document — ART's *2024 Annual
     Observatory of the Electronic Communications Market*. The Observatory itself is worth
     capturing as a `resource` entity at ingest; the figures below should be attributed to
     it (2024 reference year) and written dated. Corroborates two held/staged claims: Orange
     ahead of MTN on market share (cf. the staged 2026-03-30 ITWeb item: Orange 50.08%,
     MTN 47.2%, Camtel 2.67%) and Camtel's ~12,000 km national fibre network (cf. the staged
     2026-03-09 ITWeb China EXIMBANK Phase IV item). -->

# Cameroon's Telecom Sector Grows 18% in 2024, Driven by Mobile and Digital Services

*December 9, 2025 — Author: Joyce Onyeagoro*
