...
<!-- Note for ingest: earliest item on the device-certification thread that later becomes the
     IMEI-gating enforcement held in the staged 2026-05-22 ITWeb / 2026-05-25 Connecting
     Africa / 2026-04-01 TechCabal items. Useful as the *pre-enforcement* baseline: at this
     date the regulator is still exhorting consumers, not blocking devices. "TRB" here is the
     English rendering of ART, not a separate body. -->

# Cameroon Strengthens Digital Safety Campaign with Device Certification Guidelines

*November 10, 2025 — Author: Jennifer Onyeagoro*
