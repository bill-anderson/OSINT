---
type: source
title: Vodacom Congo calls for integrated financial ecosystem to enhance inclusion in DRC
url: https://techreviewafrica.com/news/4723/vodacom-congo-calls-for-integrated-financial-ecosystem-to-enhance-inclusion-in-drc
...
*By Kanto Kai Okanta, Tech Review Africa. Date: 2026-04-03.*

**Date note:** Tech Review Africa serves no date to search; `published` here was read from the **body of the fetched page** ("Date: 2026-04-03"), per the sweep's date-verification rule.

**Figures note for ingest:** the "nearly 35 million mobile money users" cited here sits alongside several other counts the wiki holds or has staged — 29m mobile-money **accounts** / 34.6% penetration (Q4 2024, Onafriq); "over 24 million **wallets**" across the four MMOs (TechCabal, Nov 2025); "almost 30 million citizens having a mobile money account" (Biometric Update, May 2026). These are plausibly different metrics (accounts vs wallets vs active users) rather than a straight conflict, but they are **not reconcilable as stated** and should be dated and attributed individually rather than merged.
