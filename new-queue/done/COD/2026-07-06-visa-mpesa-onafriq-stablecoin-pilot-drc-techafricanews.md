---
type: source
title: Visa, M-PESA Africa and Onafriq Launch Stablecoin Pilot in DR Congo
url: https://techafricanews.com/2026/07/06/visa-m-pesa-africa-and-onafriq-launch-stablecoin-pilot-in-dr-congo/
...
*By Kay-Lyne Wolfenden, TechAfrica News, 6 July 2026. (Exa search metadata attributed this to "Jennifer Onyeagoro" — not borne out by the page; the on-page byline is used.)*

**NOTE FOR INGEST — contested framing, see REV-006 (resolved 2026-07-16):** this piece runs precisely the "**joint stablecoin pilot launch**" framing that the wiki's REV-006 resolution identified as **trade-press gloss**. Ecofin reported **no jointly-announced pilot**; the USD peg is **inferred, not disclosed**; and one Visa partnership **awaits regulatory approval** (the BCC is pursuing de-dollarisation). The piece names **no announcement, date, spokesperson or source** for the claimed "launch". Treat as evidence of *how the story was reported*, not as corroboration that a joint pilot was launched. Do not use to out-rank the Visa-executive primary already held.
