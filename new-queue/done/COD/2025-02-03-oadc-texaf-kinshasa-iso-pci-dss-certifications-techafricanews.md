---
type: source
title: OADC Texaf - Kinshasa Achieves ISO and PCI DSS Certifications, Strengthening DRC's Digital Future
url: https://techafricanews.com/2025/02/03/oadc-texaf-kinshasa-achieves-iso-and-pci-dss-certifications-strengthening-drcs-digital-future/
...
*By Aayushya Ranjan, TechAfrica News, 3 February 2025. (Exa search metadata attributed this to "Editorial Team" — the on-page byline is used.)*

**PROVENANCE FLAG — pr-wire:** company-announcement copy ("proudly announces", "remarkable pioneering achievement") carrying only the OADC Texaf managing director's voice. The primary worth sourcing at ingest is the **OADC / TEXAF corporate announcement**, and — for the load-bearing fact — the **certification registries themselves** (ISO 27001 / ISO 22301 certificate records and the PCI DSS attestation), which are the checkable evidence that these certifications exist.

OADC Texaf – Kinshasa earns ISO and PCI DSS certifications, reinforcing cybersecurity, business continuity, and trust in DRC's digital infrastructure.
...
These certifications hold immense significance for OADC Texaf – Kinshasa's diverse clientele, including Internet Service Providers (ISPs), telecommunications operators, financial institutions and enterprises.
