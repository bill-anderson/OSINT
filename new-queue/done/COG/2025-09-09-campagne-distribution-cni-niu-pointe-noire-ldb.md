...
# Administration : lancement de la campagne de distribution de proximité des CNI et NIU

*Les Dépêches de Brazzaville / adiac-congo.com — Mardi 9 Septembre 2025 - 19:33. Par Séverin Ibara.*
...
*Légendes et crédits photo : Tribune officielle*

---

**Sweep note (not part of the source):** Materially complicates the wiki's NIU account. Two things stand out: (1) an **uncollected-card backlog** — 10,506 CNI (2016–2024) and 25,549 NIU cards (2020–2024) printed but never picked up in Pointe-Noire alone, i.e. issuance ≠ possession; and (2) the campaign is **explicitly framed around electoral-roll revision** and pre-electoral operations, linking the foundational ID to the voter register — a `sovereignty`/`gov.protect` angle the wiki's NIU material (framed via tax/banking/utilities access) does not carry. Note the NIU is supervised locally by a **police commander** ("chef de section départementale de la collecte de données").
