...
places: [BDI]
topics: [infra.connect, digital.rural, include.divides, dpi.govtech, dpi.pay, infra.cybersec, capacity.research]
entities: [[pafen], [onatel-burundi], [lumitel], [setic-burundi], [office-burundais-des-recettes], [bank-of-the-republic-of-burundi], [world-bank]]
---

> **Dating note (sweep):** Iwacu serves no publication date, and this one could not be pinned to a
> month. Bounded from content: the article describes the **BurundiPay launch (23 April 2026) as
> already done** and cites "trois années de mise en œuvre" of PAFEN; Exa's crawl was 2026-07-10.
> True publication therefore falls **between late April and early July 2026**. Recorded at year
> precision with `date_source: proxy` — the 2026-01-01 filename prefix is a sorting pad, **not** a
> date claim. Pin the exact date at ingest before citing.

# Internet haut débit : le PAFEN veut couvrir plus de 80 % du territoire

Par La Rédaction

Cette tournée avait pour objectif de permettre aux autorités administratives et aux acteurs locaux de mieux comprendre les objectifs et activités du projet, ainsi que les différentes réalisations déjà engagées dans le cadre du développement numérique du pays.
...
Le projet soutient aussi l'Initiative Masse Critique de Professionnels (IMCP), un programme destiné à renforcer les compétences nationales dans la gestion des projets.
