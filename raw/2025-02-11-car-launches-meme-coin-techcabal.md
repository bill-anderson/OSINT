...
date_source: source
places: [CAF]
topics: [dpi.pay, finance.new, gov.legislate, tech.innovate]
entities: [[faustin-archange-touadera], [beac]]
lens: [sovereignty]
...
is one segment among several unrelated stories. Only the `$CAR` meme-coin
segment (reproduced in full below) is in scope; the out-of-scope segments
(NIBSS QR codes, Kenya smartphone licence fees) are omitted. At ingest, consider
sourcing the primary — Touadéra's own X announcement — alongside this. Retained
because the wiki holds **nothing** on CAR's crypto/tokenisation track, and this
is the only in-window `$CAR` item in the fixed journal set. Note byline: Exa
metadata credited "Timi Odueso" (the editor); the page credits Muktar Oladunmade,
Faith Omoniyi and Emmanuel Nwosu as writers.

# 👨🏿‍🚀TechCabal Daily – CAR launches a meme coin

By Muktar Oladunmade, Faith Omoniyi, and Emmanuel Nwosu
11th Feb, 2025

## Cryptocurrency — Central African Republic launches meme coin, $CAR
...
*Crypto tracker, data as of 05:25 AM WAT, February 11, 2025: Bitcoin $98,094 · Ether $2,702 · Solana $203.85.*
