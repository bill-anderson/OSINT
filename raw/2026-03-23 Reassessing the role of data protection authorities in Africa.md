...
> ## Excerpt
> The global data governance landscape is rapidly evolving, presenting an opportune moment for African policymakers to reassess the role of domestic data protection authorities.  A key aspect to good data governance is balancing the tension between enabling innovation in data driven technologies and protecting individual rights. Since 2016, African states have tended towards the latter, driven by the …

---
_The global data governance landscape is rapidly evolving, presenting an opportune moment for African policymakers to reassess the role of domestic data protection authorities._ 
...
In September 2025, the EU Commission released the **[EU Data Union Strategy](https://eur-lex.europa.eu/legal-content/ES/TXT/?uri=COM:2025:835:FIN)**. It recognises the unwieldy regulatory burden that the GDPR places on businesses and emphasises the need to promote access to data to enable innovation in emerging technologies. As the European Commissioner for Tech Sovereignty, Security and Democracy stated, **[“regulation alone is not enough, as we know, we must also move from rulemaking to innovation building…we need immediate steps to get rid of regulatory clutter.”](https://iapp.org/news/a/european-commission-proposes-significant-reforms-to-gdpr-ai-act)**
...
This approach has seen wide dissemination and reflexive replication by African policymakers concerned that regulatory inaction may stifle digital services trade and foreign direct investment (the ‘**[Brussels effect](https://academic.oup.com/book/36491)**’). More recently, this approach has been codified by **[Article 21 of the AfCFTA DTP](https://au.int/sites/default/files/treaties/44963-treaty-EN_-_Protocol_to_AfCFTA_Agreement_on_Digital_Trade.pdf)** and **[Articles 4-15 of the DTP Annex on Cross-border Data Transfers](https://au.int/sites/default/files/treaties/44963-ax-ENG_Circulation_Digital_Trade_Compiled_Certified_Legal_Instruments_38thAssembly_Feb_2025_27_May2025.pdf)**, creating a binding obligation for African states to adopt or maintain an omnibus approach moving forward.
...
For example, Lesotho’s 2011 Data Protection Act has been law for over a decade but the Data Protection Commission **[has remained unappointed](https://zmayetlaw.co.ls/lesothos-outdated-data-protection-act-no-commissioner-no-teeth-what-should-change-next/)**, while South Africa’s Information Regulator (one of the most well-resourced African DPAs) has reported **[severe capacity constraints, an inability to retain skilled staff and funding shortfalls.](https://inforegulator.org.za/wp-content/uploads/2025/11/Information-Regulator-Annual-Report-2025-210mm-x-260mm-1.pdf)**

#### **A way forward: integrating sectoral regulators into national data governance processes**

African states find themselves in a difficult position, obliged to adopt GDPR-inspired omnibus data protection frameworks under the DTP yet lacking the requisite legal, supervisory, technical and financial resources to effectively enforce them (a textbook example of the ‘**[transplant effect](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=4786872)**’, which refers to the direct transposition of foreign legal frameworks without adequate consideration for local context).

However, these resources can often be found in the sectoral regulators that administered and enforced implicit (and rarely, **[explicit](https://www.mondaq.com/india/data-protection/730232/trai-says-personal-data-belongs-to-users-telecom-companies-mere-custodians)**) sectoral data protection requirements prior to the adoption of national data protection legislation.

Financial sector regulators in particular often have **[a history of sectoral data governance in Africa](https://cenfri.org/wp-content/uploads/2018/11/2018_10_30_regulating_for_responsible_data_web.pdf)**, **[and extensive experience in striking the balance between protection and innovation](https://empowerafrica.com/regulatory-sandboxes-in-africa/)**. Moreover, while the DTP obliges the adoption of an omnibus approach, it also recognises its non-mutual exclusivity with sector specific regulation: **[Article 19(c) of the Annex on Cross-Border Data Transfers](https://au.int/sites/default/files/treaties/44963-ax-ENG_Circulation_Digital_Trade_Compiled_Certified_Legal_Instruments_38thAssembly_Feb_2025_27_May2025.pdf)** calls for states to encourage “the development of industry-specific self-regulatory data codes of conduct.”
...
There is precedent for this approach: South Africa’s Protection of Personal Information Act empowers the Information Regulator to accept and issue sector-specific codes of conduct upon application by a representative industry body (**[Section 61.1(b)](https://popia.co.za/section-61-process-for-issuing-codes-of-conduct/)**). This has led to the Information Regulator issuing a code of conduct for the Banking Association of South Africa and Credit Bureau Association respectively that **[were both drafted and submitted by each respective industry body](https://bowmanslaw.com/insights/south-africa-first-codes-of-conduct-issued-by-the-information-regulator-under-popia/)**. While these are examples of ‘bottom-up’ policy shaping by industry bodies, it shows that African sectoral expertise can be effectively utilised by DPAs to guide national data policy processes.

As a more explicit international example, the Financial Conduct Authority and Information Commissioners Office in the United Kingdom have a long history of joint data governance regulation in the financial sector. They regularly issue **[memoranda of understanding (MOU)](https://ico.org.uk/media2/migrated/4027807/ico-fca-mou.pdf)** that establish areas of cooperation, information sharing, and delineate respective regulatory boundaries. Beyond MOUs, they also actively pursue strategic joint initiatives. These include developing **[AI regulatory sandboxes](https://ico.org.uk/about-the-ico/media-centre/news-and-blogs/2025/06/tech-trust-and-teamwork-how-the-fca-ico-are-helping-innovation-take-off/)** and **o[pen finance frameworks](https://www.drcf.org.uk/publications/blogs/the-future-of-open-finance-and-smart-data-joint-insights-from-the-fca-and-ico)**, and issuing **[guidelines](https://www.dacbeachcroft.com/en/What-we-think/Targeted-support-meets-data-protection-navigating-the-ICO-and-FCAs-joint-statement-on-direct#:~:text=The%20regulators'%20aim%20is%20to,consumers%20called%20%22targeted%20support%22.)** on specific areas of innovation.
