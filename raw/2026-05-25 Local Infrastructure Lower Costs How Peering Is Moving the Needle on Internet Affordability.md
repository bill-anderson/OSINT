...
When Internet service providers, content networks, and other operators exchange data through a local [Internet exchange point (IXP)](https://www.internetsociety.org/resources/doc/2020/explainer-what-is-an-internet-exchange-point-ixp/), keeping traffic closer to where it is generated and consumed, it’s a different picture. This reduces the distance data has to travel, lowers the cost of moving it across networks, and improves speed and reliability.
...
[Internet Society Pulse](https://pulse.internetsociety.org/en/) curates data from trusted sources to measure the availability, evolution, and resilience of the Internet. Pulse reports “average Internet cost” as the percentage of an average person’s income that’s needed to pay for a low-consumption mobile broadband package, using at least 3G technology, including a minimum of 1GB of data. We analyzed data on the progression of Internet cost in countries where the Internet Society Foundation [provided grants for IXP development or local peering ecosystem support](https://www.isocfoundation.org/grant-programme/sustainable-peering-infrastructure/) between 2020 and 2024, and we saw the needle move.
...
![A bar chart showing the percent change in the share of income needed to afford a basic mobile broadband plan by country since first Foundation grant](https://www.internetsociety.org/wp-content/uploads/2026/05/Affordability-Chart.jpg)

The largest shift occurred in [](https://www.internetsociety.org/blog/2025/04/local-businesses-benefit-from-burkina-fasos-internet-development/)Burkina Faso. In 2019, the Burkina Faso Internet Exchange, or BFIX, reached out to the Internet Society for support to improve its network design and implement IXP best practices.
...
![A graph showing % change in the share of income needed to afford a basic mobile broadband plan by year, by country, marking grant years. ](https://www.internetsociety.org/wp-content/uploads/2026/05/Affordability-Variation-Graph.jpg)
...
[Meaningful connectivity](https://www.internetsociety.org/blog/2025/10/what-is-meaningful-connectivity/) is about being able to use the Internet in ways that create real opportunity. To support this, one of the Internet Society’s [strategic goals](https://www.internetsociety.org/resources/doc/2024/2030-strategy/) is to reduce barriers to access while improving speed and affordability.
...
##### [Learn more about our work to support peering infrastructure.](https://www.internetsociety.org/our-work/connectivity/peering/) 
