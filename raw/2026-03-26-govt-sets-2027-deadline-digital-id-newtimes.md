...
# Govt sets 2027 deadline for full shift to digital ID

The government will phase out current national identity cards by June 2027, requiring all citizens to transition to the new Single Digital ID (SDID) by that time.
...
Officials warn that individuals who fail to obtain the Digital ID risk difficulties accessing services, as institutions increasingly adopt systems that rely on digital verification.
...
[CLIP — body recovered from allAfrica syndication of the original New Times article; newtimes.co.rw body not directly retrievable]
