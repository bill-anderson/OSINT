...
*Whether you are a regular reader or a first-timer, discover our offers to delve deeper into and* [*support the Grand Continent by subscribing to the magazine*](https://legrandcontinent.eu/fr/offre-abonnement/)

## Starting from the commons: a plea for a global stack

French President Emmanuel Macron recently stated that Europe is going through an existential moment. This is not an exaggeration. In fact, the entire world is experiencing one. Guiding—and, if necessary, curbing—the development of AI is now the most important issue we collectively face.

As the AI Impact Summit opens today in New Delhi, states, businesses, civil society, and all stakeholders have an opportunity to create a new non-aligned movement around the fundamental principles of open, resilient, and collaborative AI. Drawing inspiration from the Non-Aligned Movement, which sought to remain neutral during the Cold War in the 1950s and 1960s, this initiative aims to answer the fundamental question of our technological sovereignty: who controls and influences AI?

Before asking where, when, and how countries can exercise their control and power to create and deliver AI that truly serves human and public interests, we must start with a key concept: the *stack*

The AI *stack — which could be translated, albeit inaccurately, as "stacking" — is the hierarchy of components needed to build, run, and scale AI applications.*

It is generally broken down as follows:

- the *infrastructure* layer: that is, the hardware (e.g., GPUs) and the cloud platforms on which it operates (e.g., providers like Amazon Web Services);
- the *model* layer: that is to say the language models themselves (such as GPT-4 or Claude) and the tools to exploit them;
- the *data* layer: that is, all the information used to train and run the models; and finally
- the *application* layer: that is, the point of junction between the model and its users — whether the device used is consumer or professional.

For almost all countries, vertically controlling all layers of this stack is impossible: beyond the extremely high investment cost, access to technology, expertise, and energy remains unevenly distributed across the globe. A country may always declare its desire to have sovereign control over its own semiconductors, data centers, models, and applications. In practice, however, the economies of scale required to build a complete *stack* are a deterrent.

However, countries and their populations want a "sovereign" AI, unique, very specific to their history, their culture and finely adapted to the needs and results of public interest, which are intrinsically contextual.

How to achieve this?

First of all, it must be recognized that "open" *stacks* are smarter and more resilient.

Openness in the field of artificial intelligence—defined here as AI models freely accessible for use, study, modification, and sharing, models that combine elements of open science, open innovation, and open data and sources—enables this third way. Open *stacks* allow middle powers—that is, in fact, all powers that have an interest in it—to leverage the social, economic, and political value of AI.

Secondly, it is clear that no country, with the exception of China and the United States, can aspire to have a fully sovereign *stack* — sovereignty being defined here as action and control over all aspects of this *stack*, the various stages of production of key AI applications.
...
Dans le domaine de cette technologie, c’est une réponse à [l’appel formulé par Mark Carney d’une alliance des puissances moyennes à Davos](https://legrandcontinent.eu/fr/2026/01/21/le-discours-integral-de-mark-carney-a-davos/).
...
[^1]: Sara Hooker, « [On The Slow Death Of Scaling](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=5877662) », décembre 2025.

[^2]: [Open Source: How Middle Powers Can Build Influence in the Age of AI](https://institute.global/insights/tech-and-digitalisation/open-source-influence-age-of-ai#footnote_1)

[^3]: [Data Stewards Network](https://medium.com/data-stewards-network)

[^4]: Voir ici leur [site Internet](https://roost.tools/)

[^5]: [\[2405.15802\] Towards a Framework for Openness in Foundation Models: Proceedings from the Columbia Convening on Openness in Artificial Intelligence](https://arxiv.org/abs/2405.15802)

[^6]: Voir « [Open banking: setting a standard and enabling innovation](https://theodi.org/insights/projects/open-banking-setting-a-standard-and-enabling-innovation/) », *The Open Data Institute*, 26 octobre 2016.

[^7]: Voir leur [site Internet](https://www.currentai.org/)