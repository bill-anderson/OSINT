...
# Statistiques : des données régulières pour mieux mesurer le marché du travail

*Les Dépêches de Brazzaville / adiac-congo.com — Samedi 11 Juillet 2026 - 12:32. Par Fiacre Kombo.*
...
*Légendes et crédits photo : Nedia Touihri au cours d'un atelier de formation /DR*

---

**Sweep note (not part of the source):** First substantive **`data.statistics`** item for COG in the sweep. Establishes the **INS (Institut national de la statistique)** and its DG — no wiki entity page exists. `data.statistics` is not currently among COG.md's active topics despite being in the taxonomy.
