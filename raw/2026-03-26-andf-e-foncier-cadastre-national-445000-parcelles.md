...
places: [BEN]
topics: [dpi.registry, dpi.govtech, gov.legislate, include.access]
entities: [[andf-benin], [e-foncier-benin], [ppmec], [anip-benin]]
---

# Modernisation de l'ANDF : « e-Foncier » au service de la sécurité des investissements
...
Une nouvelle ère s'ouvre pour l'administration foncière au Bénin. Après le succès du projet de modernisation de l'administration foncière (PMAF) qui s'est achevé en juin 2023, le projet de préparation de la mise à l'échelle du cadastre national (PPMEC) (juillet 2023 – juin 2026) prend désormais le relais avec une ambition revue à la hausse. Toujours soutenu par l'ambassade du Royaume des Pays-Bas, ce programme ne se contente plus de moderniser ; il prépare la généralisation du cadastre à l'échelle nationale.

## Une architecture numérique robuste

Au centre de ce dispositif, la plateforme e-Foncier Bénin (e-FB) pilotée par l'Agence Nationale du Domaine et du Foncier (ANDF). Véritable colonne vertébrale du système, cet outil numérique permet une gestion durable et centralisée des données cadastrales. L'objectif est de rendre l'institution capable de maintenir et de développer ce système pour répondre aux besoins croissants des populations et des investisseurs.
...
Le projet ne laisse personne de côté. L'un des piliers du projet de préparation de la mise à l'échelle du cadastre national est de renforcer les capacités de la société civile pour veiller à la prise en compte des groupes vulnérables, notamment les femmes, les jeunes et les migrants.
...
## Plus de 445 000 parcelles déjà sécurisées
...
La commune de Cotonou bénéficie déjà d'une couverture intégrale en données cadastrales. Elle est suivie de près par Parakou et Porto-Novo, dont la couverture totale est actuellement en cours de finalisation. Au-delà des grands centres urbains, le projet déploie ses ailes dans plusieurs localités stratégiques telles que Ouèdo (Abomey-Calavi), Sèmè Podji (sémé, Agblangandan, une partie de Ekpè), Agoué (Grand-Popo), Azovè (Aplahoué), Bohicon (1er, 2éme arrondissements et Passagon), Sakété (Takon et Sakété 2), Pobè (Ahoyéyé et Pobé), Djougou (1er et 2ème arrondissements) ou encore Sirarou (N'Dali). Dans ces zones, l'impact est immédiat : une réduction significative des conflits fonciers a été observée là où le cadastre est opérationnel.
