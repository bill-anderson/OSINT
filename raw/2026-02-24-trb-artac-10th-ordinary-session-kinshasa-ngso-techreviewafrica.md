...
<!-- Date and byline established from the page body ("Date: 2026-02-24", "By: Nana Appiah
     Acquaye"). This outlet serves no date metadata. -->

<!-- Note for ingest: **the most consequential item in this completion pass and arguably in
     the CMR journal sweep.** Not a PR-wire piece — it reports a regional regulators'
     conference (ARTAC 10th Ordinary Session, Kinshasa) and carries substantive adopted
     positions. Why it matters:

     1. **A Central African data-residency position, in writing.** A high-level expert panel
        recommended a harmonised NGSO framework requiring satellite providers (Starlink,
        OneWeb, Amazon Kuiper are named) to (a) establish **terrestrial gateways within ARTAC's
        jurisdiction**, (b) meet financial obligations equivalent to traditional operators, and
        (c) **ensure citizens' data remain stored within the African continent**. That is a
        data-sovereignty demand aimed squarely at US hyperscaler/LEO constellations, and it
        directly counterpoints the staged CAMTEL–AWS (2026-07-08) and CAMTEL–Avanti
        (2026-04-09) engagements. `geopol.usa` is deliberately *not* tagged — the framework is
        provider-agnostic in form — but the named targets are all US/UK.
     2. **A dated regional commitment:** free roaming across Central Africa mandated by
        **30 June 2026**. Cross-check against the CEMAC free-roaming directive referenced in
        the 2025-05-16 Cameroon–Chad item (also staged this pass) — same policy, two dated
        waypoints.
     3. **A dated benchmark:** mobile internet penetration **below 30%** across much of Central
        Africa (as of Feb 2026).
     4. ARTAC institutional housekeeping: revised statutes adopted; Executive Committee mandate
        extended to **December 2027**.

     ARTAC has no entity page. Tagged COD as the venue and XCA as the substantive scope. -->

# Cameroon's TRB participates in ARTAC's 10th Ordinary Session in Kinshasa

*Date: 2026-02-24 — By: Nana Appiah Acquaye*
...
*[Body captured at fetch 2026-07-17. Body text ends mid-sentence in the fetched capture; the
final clause is completed from the visible page text.]*
