...
For example, Ethiopia has been among the first countries to take advantage of assessment for its digital ID system, FAYDA. Ethiopia’s National ID Program (NIDP), in charge of deploying FAYDA, has been exploring ways to better evaluate the system’s design — understanding where the system is strong and where improvements are needed to support future growth and strengthen intended outcomes.

In early 2025, NIDP leveraged the Digital ID Assessment as part of its commitment to continuous learning and improvement. For more information, [read NIDP’s report outlining insights from the assessment](https://drive.google.com/file/d/1PrJBapUJHvha1PWg05KJjtNhpQUYlv9f/preview), as well as [DIAL’s paper documenting key takeaways and recommendations going forward](https://dial.global/research/digital-id-assessment-continuous-learning-ethiopia/).

***If you’re interested in learning more about the Digital ID Assessment, please reach out to the team at [info@dial.global](mailto:info@dial.global).***