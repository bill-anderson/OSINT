...
Whether the merchant pivot succeeds will depend largely on what PayInc and the Reserve Bank can extract from the participating banks – the same institutions whose pricing has, by PayInc’s own admission, been holding the system back. –
