...
The draft regulations on the rapid deployment of electronic communications networks and facilities, gazetted on Friday — [read them here](https://techcentral.co.za/wp-content/uploads/2026/04/54484-10-4-ICASA.pdf) (PDF) — give effect to the national rapid deployment policy issued by the communications minister in March 2023. Public comments are open for 30 working days, closing in late May.

While the regulations are intended as a tool to accelerate broadband roll-out by streamlining land access and dispute resolution, the most consequential provision is regulation 7, which establishes a national rapid deployment GIS ([geographic information system](https://en.wikipedia.org/wiki/Geographic_information_system)) database.
