---
type: source
title: "2025 PARTECH AFRICA TECH VC REPORT: AFRICAN TECH FUNDING REBOUNDS TO US$4.1B"
url: https://partechpartners.com/news/2025-partech-africa-tech-vc-report-african-tech-funding-rebounds-to-us41b-driven-by-record-debt-activity-and-disciplined-equity-growth
publisher: Partech Partners
...
*Primary: Partech's own release of its annual Africa Tech VC Report — the announcing party's record, and
the citable origin for the CY2025 headline the wiki previously held only via secondary summary
([[raw/2026-02-26 The AfDB's push for African financial sovereignty, and a tech investment rebound]]).*

*__Not commensurable with [[disrupt-africa]]__ (resolved 2026-07-20). Partech counts __equity plus debt,
by deal__, across a wide tech universe; Disrupt Africa publishes a __self-declared minimum floor, by funded
venture__, restricted to a narrow startup test. The two series must never be summed, averaged or used to
check one another. Two traps: (1) Partech's __72% of capital__ to the big four is a share __by value__,
while Disrupt Africa's 72.5% is a share __by count__ (129/178) — its by-value share is __88%__, so the two
__diverge by 16 points__, they do not agree; (2) Partech's __debt subtotal (US$1.64bn)__ is numerically
identical to Disrupt Africa's __total__ (US$1.6367bn) — __coincidence, not reconciliation__.*
