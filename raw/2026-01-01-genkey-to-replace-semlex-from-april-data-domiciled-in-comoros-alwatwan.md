---
type: source
title: "Impression des documents biométriques : Genkey remplacera Semlex à partir du mois d'avril prochain"
url: https://alwatwan.net/societe/impression-des-documents-biom%C3%A9triques-i-genkey-remplacera-semlex-%C3%A0-partir-du-mois-d%E2%80%99avril-prochain.html
publisher: Al-Watwan
...
ingested: 2026-07-18
places: [COM]
topics: [dpi.id, gov.protect, include.access, infra.store]
...
**Sweep note — date.** Al-Watwan prints no publication date and this piece carries no dateline.
Internal evidence bounds it to **after 27 December 2025**: it cites an interview given "fin
décembre" and quotes the minister "le 27 décembre dernier", and refers to Genkey arriving "dès
le mois d'avril 2026" with Semlex's contract ending "en mars 2026". Padded to `2026-01-01` with
`date_precision: month`, `date_source: proxy` per the currency rules — the month is inferred,
not printed.

**Sweep note — significance.** This **re-dates** held wiki material. `wiki/places/COM.md` dates
the Genkey/Semlex switch to **2026-02-16** (from a Comores Infos report). This Al-Watwan piece
shows the minister announced it in an interview on **27 December 2025**, and that it was raised
in parliament on **4 and 6 December 2025** — i.e. the story was public ~6–10 weeks earlier than
the wiki's earliest source. It also supplies the **data-domiciliation** rationale (Comorian
biometric data held in Belgium under Semlex) and the **Reuters 2017 Semlex investigation**,
neither of which the wiki holds. State paper: government framing throughout.

# Impression des documents biométriques I Genkey remplacera Semlex à partir du mois d'avril prochain

Le nouveau prestataire que les autorités ont choisi est une société néerlandaise fondée en 2001 et qui propose des programmes biométriques à des institutions et des gouvernements, notamment en Afrique.
...
Lors d'une séance de questions orales au gouvernement, un député avait même interpellé le ministre de l'Intérieur sur ce problème. «Depuis la mise en œuvre des passeports et cartes d'identité biométriques en 2008, nous avons constaté des lenteurs et des surcoûts qui affectent particulièrement les citoyens des iles de Mwalii et de Ndzuani», a reconnu le premier flic du pays, le 6 décembre devant les élus de la nation, ajoutant que parfois le traitement pouvait aller jusqu'à 15 jours, voire plus. A cela s'ajoutent les coûts supplémentaires que doivent supporter les habitants des autres îles, favorisés en partie par l'abandon des procédures d'urgence jadis facilitées par des dispositifs techniques spécifiques.
