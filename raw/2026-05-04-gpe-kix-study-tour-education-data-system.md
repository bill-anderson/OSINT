...
ingested: 2026-07-20
places: [TGO, GMB]
topics: [dpi.mis, data.statistics, dpi.exchange, capacity.training, capacity.research, include.access]
entities: [[gpe-kix], [global-partnership-for-education], [hisp-centre], [hisp-wca], [dhis2], [stateduc], [cspro], [mepsta-togo], [mobse-gambia], [university-of-oslo], [university-of-the-gambia], [education-data-toolkit], [empowering-districts-and-schools-with-data], [sdg4], [terje-aksel-sanner], [kirti-thakur], [jerry-aziawa], [pamod-amarakoon], [sena-yawo-akakpo-numado], [efoe-gbetoglo]]
body_completeness: full
---

*Note: body is complete. Photo captions are retained inline as published.*

# GPE KIX study tour documents what it takes to build an education data system
