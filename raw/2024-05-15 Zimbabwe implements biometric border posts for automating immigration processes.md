...
entities: [[department-of-immigration-zimbabwe], [garsu-pasaulis], [obms-zimbabwe]]
---

*HISTORICAL BASELINE — the oldest clip in the batch, predating every entry currently on the ZWE hub, and it describes a PILOT ('initially be tested' at three ports of entry). The wiki holds nothing on its outcome (GAP-ZWE-002): write it dated, do not imply current operation. Wholly derivative of The Sunday Mail (state-owned) — the 'first in SADC' claim is state-media framing the author himself hedges with 'reportedly'. The analytically interesting facts the source does not argue: a single Lithuanian vendor (Garsu Pasaulis) supplies both Zimbabwe's passports and its border database, on an architecture derived from Dubai's Smart Gates, with centralised cross-agency biometric sharing and no oversight mentioned.*
...
Respect Gono, the chief director of immigration, says in an interview with The Sunday Mail that implementing a new border management system will improve the coordination of all border agencies, suggesting a centralized platform that would enable different border control and security agencies to access and share information.
