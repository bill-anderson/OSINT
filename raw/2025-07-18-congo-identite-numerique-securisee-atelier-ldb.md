...
# Digitalisation : le Congo veut se doter d'une identité numérique sécurisée

*Les Dépêches de Brazzaville / adiac-congo.com — Vendredi 18 Juillet 2025 - 15:41. Par Firmin Oyé.*

Le ministère des Postes, des Télécommunications et de l'Économie numérique à commémoré, le 16 juillet à Brazzaville, la journée de l'identité numérique. Lors de l'atelier organisé à cet effet, le gouvernement a relevé la nécessité d'offrir au Congo une identité numérique fiable et sécurisé.
...
*Légendes et crédits photo : 1-Le ministre Léon Juste Ibombo délivrant son allocution à clôture des travaux/Adiac 2-Une vue des participants lors des travaux/Adiac*

---

**Sweep note (not part of the source):** **Same event, different outlet** as the held `raw/2025-07-17 Congo - national workshop launches secure digital-identity system push.md` (sourced from aci.cg). Per the sweep rule this is **not a drop** — it adds the Thales representative's name (**Laurent Jutard**), the full list of documents Thales expects the system to secure, the workshop theme, the "Congo Digital 2025" framing, and CARIA's positioning as the "clé de voûte" of the PATN. Attach to the existing event at ingest rather than spawning a parallel page.
