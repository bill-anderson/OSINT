---
type: source
title: "Data Protection Act, 2024 (Act No. 3 of 2024)"
url: https://www.mca.ac.mw/mca-siteup/uploads/Data%20Protection%20Act%202024.pdf
publisher: Government of Malawi (Malawi Government Gazette)
...
entities: [[malawi-data-protection-act-2024], [macra-malawi], [lazarus-chakwera], [parliament-of-malawi], [malawi-communications-act-2016], [malawi-electronic-transactions-and-cyber-security-act]]
lens: [sovereignty]
body_completeness: excerpt
---

> **PARTIAL CAPTURE — flagged for manual re-clip.** The statute runs to 53 sections; the fetch returned the front matter (assent block, arrangement of sections) and Parts I–II verbatim, breaking off partway through section 6. What is reproduced below is the source's own words with nothing paraphrased, but it is **not the full Act**. The load-bearing provisions for the contradiction it settles are present: the assent block (assent 31 January 2024; published 2 February 2024; passed in Parliament 7 December 2023), section 1 (commencement on a date the Minister appoints by Gazette notice — exercised by Government Notice 40 of 2024, dated 31 May 2024, commencing the Act on 3 June 2024), and section 4 (MACRA designated as the Data Protection Authority). Section 53 (transitional provision: six months for controllers/processors of significant importance, twenty-four months for all others) is **not** in the captured range and should be verified against the full text on re-clip.
...
"third party" means a natural or legal person other than a data subject, data controller or processor, who is authorized to process personal data under the direct authority of a data controller or data processor.
...
5.—(1) the authority shall regulate the processing of personal data as prescribed under this act and oversee the implementation, and be responsible for the enforcement, of this act.
...
6. the authority may—
(a) designate a country, region or sector as affording adequate personal data protectio

[capture ends here — remainder of the Act not retrieved]
