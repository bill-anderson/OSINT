...
<!-- First-party: 6-month Google AI Plus trial + data-free (zero-rated) Gemini app across
     Cassava's TSP network. Quoted: Hardy Pemhiwa (Cassava CEO), Josh Woodward (Google Labs).
     The sovereign-AI narrative distributing a US hyperscaler model — cross-link the tension. -->

# Cassava Tech - Partners with Google to bring Google Gemini to millions in africa

> ## Excerpt
> Cassava Technologies, has announced a strategic partnership to expand access to Google Google's advanced AI, Gemini, across the continent.

---
Cassava Technologies, a global technology leader of African heritage, has announced a strategic partnership to expand access to Google’s advanced AI, Gemini, across the continent.
...
Visit the [Google AI Plus](https://support.google.com/googleone/answer/16548195?hl=en#zippy=) page for a full list of features. 
