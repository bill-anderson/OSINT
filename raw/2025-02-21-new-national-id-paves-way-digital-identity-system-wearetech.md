...
<!-- Byline and date established from the fetched page, which carries an in-body line
     "By : Samira Njoya / Date : vendredi, 21 février 2025 16:30". Agrees with Exa metadata. -->

<!-- Note for ingest: mostly forward-looking analysis of what a digital ID *could* enable —
     the prospective passages ("citizens could gain access...", "could serve as the foundation
     for secure electronic voting") are the outlet's framing, not reported fact, and should not
     be compiled as Cameroonian policy. The datable payload is narrower but real: **online
     pre-enrolment for the new CNI opened 17 February 2025**, ahead of the 3 Mar 2025 issuance
     start held in the staged Biometric Update item. Fills the gap between the Feb-2025 system
     go-live and the Mar-2025 issuance.

     Possible error at source: the piece cites "ISO/IEC 9303" for the card standard. 9303 is an
     **ICAO** standard (ICAO Doc 9303, machine-readable travel documents), not ISO/IEC. Do not
     propagate the ISO/IEC attribution; verify against the DGSN/Augentic specification at
     ingest. -->

# Cameroon: New National ID Paves Way for Digital Identity System

*By: Samira Njoya — Date: vendredi, 21 février 2025 16:30*
