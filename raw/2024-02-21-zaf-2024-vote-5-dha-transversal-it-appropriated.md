...
## Development history
- **2024-10-30 (resolved 2026-07-22 from the acquired FullAENE)** — the open B14 question closes: this subprogramme was **cut R79,462k by virement → adjusted R1,110,636k** while the vote's +R1.6bn addition flowed to Corporate Services (+R505.0m). Revised-stage record: `zaf-2024-vote-5-dha-transversal-it-revised`. (Main appropriation finer precision per AENE: R1,190,098k.)
