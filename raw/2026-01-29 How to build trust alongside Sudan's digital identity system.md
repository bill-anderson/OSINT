...
A national digital identity platform could help to provide much-needed stability in Sudan, with benefits extending beyond its borders.

Image: Unsplash/KamalUddin
...
##### Share:[What's the World Economic Forum doing to *accelerate action on Emerging Technologies?*](https://www.weforum.org/impact/cybercrime-atlas/)

##### [Explore and monitor how Digital Identity is affecting economies, industries and global issues](https://intelligence.weforum.org/topics/a1G0X000005JJGcUAO?tab=publications)
...
More than [800 million people](https://blogs.worldbank.org/en/digital-development/global-progress-in-identification--3-findings-from-the-latest-da) worldwide still lack official proof of identity, according to the World Bank's Identification for Development Dataset. This can limit access to social protection, finance and even basic rights. Countries such as Nigeria and Estonia that have introduced robust digital ID systems are using them to strengthen their institutions and expand opportunities for their citizens.

Sudan is currently preparing to launch [SudaPass](https://sudanhorizon.com/sudan-announces-imminent-launch-of-the-national-digital-id/), a unified national digital identity platform announced by the Ministry of Telecommunications and Digital Transformation as part of its wider [Baladna digital government programme](https://sudanhorizon.com/e-government-is-the-future-of-digital-transformation-in-sudan-2-2/). The announcement comes as Sudan works to restore services and strengthen institutions amid ongoing conflict.

More than [30 million people](https://www.unocha.org/sudan) in Sudan require humanitarian assistance, according to UN figures, and more than [14 million people](https://news.un.org/en/story/2025/10/1166237#:~:text=Sudan%20has%20become%20the%20site,other%20deadly%20diseases%20are%20increasing.) have been displaced out of a population of 51 million. The scale of movement, conflict-driven disruption of registries and absence of updated population data since the [2008 national census](https://microdata.worldbank.org/catalog/1014) limit planning and weaken service delivery. Disrupted population data now affects every sector – from health coverage to education planning and emergency response.

Sudan's instability also reverberates far beyond its borders. The country borders seven other nations whose political and economic trajectories shape the Sahel, the Horn of Africa, North Africa and West Asia. As the second largest Red Sea coastline, Sudan also anchors one of the most strategic maritime corridors, which carries close to [10% of global maritime trade](https://unctad.org/publication/review-maritime-transport-2023). And the country holds one of the world’s largest untapped [foundations for food security](https://www.weforum.org/stories/2024/03/sudan-agriculture-world-food-crisis-solution/#:~:text=Sudan's%20history%20of%20ongoing%20conflict,lemons%20and%20oranges%2C%20BLNews%20reports.) because of its vast arable land and extensive river systems.
...
India, on the other hand, has achieved significant reductions in leakage of benefit transfers through its Aadhaar digital identity programme and [Direct Benefit Transfer platform](https://www.pib.gov.in/PressReleasePage.aspx?PRID=2123192&noshow=1&reg=3&lang=2). Estonia has created one of the world’s most efficient public administrations by linking nearly every public service to a secure digital identity through its [e-ID system](https://e-estonia.com/solutions/e-identity/id-card/). And Nigeria has strengthened financial inclusion and regulatory oversight by registering more than 100 million people under its national identity number through a [World Bank supported programme](https://projects.worldbank.org/en/projects-operations/project-detail/P167183).
