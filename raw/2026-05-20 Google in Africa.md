...
<!-- EXPERT ANALYSIS (Data Landscapers, author [[bill]]). "Partner or predator?" — audit of
     Google's full-stack African footprint (Equiano/Umoja cables, JHB cloud region, free Gemini,
     Cassava distribution, AU/UNECA/AfCFTA MoUs) as a land-and-expand strategy producing
     structural dependency. ADDS framing beyond the wiki's [[google]] page (guard 1 satisfied).
     Discrete facts (pledge figures, MoUs) trace to Google/AU primaries. -->
...
[**Download the full report.**](https://data-landscapers.com/assets/pdfs/2026-google-in-africa.pdf)
