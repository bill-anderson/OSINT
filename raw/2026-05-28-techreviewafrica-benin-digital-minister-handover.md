...
places: [BEN]
topics: [gov.policy, tech.ai, capacity.training, dpi.govtech]
entities: [[ministry-of-digital-benin]]
---

<!-- Provenance note: Tech Review Africa is a byline-free PR wire (README source table). Published date established from the page's own "Date:" line at fetch time — Exa served no date. Sourcing the underlying ministry statement / Council of Ministers record would be preferable at ingest. -->
