---
type: source
title: "Kinshasa investit dans les drones : entre l’espoir et le doute"
url: https://rdc-monde.com/kinshasa-investit-dans-les-drones-entre-lespoir-et-le-doute/
...
metadata suggests 2026-01-14 but is unreliable. The page header renders a crawl-time
site clock ("dimanche, juin 14, 2026") which must NOT be read as a publication date.
Date set to month precision (2026-01-01) as a proxy; the month rests only on Exa's
unreliable metadata and is uncertain. -->
