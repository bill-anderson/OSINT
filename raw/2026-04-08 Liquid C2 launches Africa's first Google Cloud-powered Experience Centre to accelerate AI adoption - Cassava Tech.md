...
<!-- First-party: Africa's first Google Cloud-powered Partner Experience Centre, Johannesburg
     (Gemini Enterprise, Playspace, Solutions Pods, local-currency billing). Quoted: Ziaad
     Suleman (Cassava SVP), Tara Brady (Google Cloud EMEA President). -->

# Liquid C2 launches Africa’s first Google Cloud-powered Experience Centre to accelerate AI adoption - Cassava Tech

> ## Excerpt
> Liquid C2, a business of Cassava Technologies, a global technology leader, has launched Africa’s first Partner Experience Centre powered by Google Cloud in Johannesburg, South Africa. The state-of-the-art facility is designed to empower partners and resellers to move beyond traditional ... Read More
