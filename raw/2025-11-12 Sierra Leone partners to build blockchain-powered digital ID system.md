---
type: source
title: Sierra Leone partners to build blockchain-powered digital ID system
url: https://www.biometricupdate.com/202511/sierra-leone-partners-to-build-blockchain-powered-digital-id-system
...
> ## Excerpt
> MoCTI signed an MoU (Nov 2025) with California-based Sign (CEO Xin Yan) to build "sovereign blockchain infrastructure" — a national digital ID system, digital wallet and asset-tokenization framework — coordinated from the Felei TechCity hub. This is the bilateral MoU that the July-2026 tri-party (Bhutan NDI) platform builds on.

---

Sierra Leone has entered into a partnership agreement with scalable digital infrastructure firm Sign to power its digital transformation with blockchain technology.
