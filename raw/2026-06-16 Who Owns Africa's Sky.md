...
The competitive asymmetry extends beyond pricing and into licensing. In Senegal, the traditional operator Sonatel [paid](https://example.com/) [over $50 million](https://example.com/) for a 5G licence. Starlink paid $150,000 for its licence, yet both compete for the same enterprise customers.

Meanwhile, African mobile operators are expected to [invest $77 billion](https://example.com/) in networks between 2024 and 2030, according to the GSMA. That investment depends on retaining the high-value customers satellite providers are now actively targeting. However, Starlink’s price advantage is not universal. Across 12 African markets surveyed in January 2025, Starlink undercut leading ISPs in only 5 markets, with local providers remaining cheaper in countries such as Rwanda, Benin, and Nigeria.

<iframe src="https://flo.uri.sh/visualisation/29290569/embed" title="Interactive or visual content" frameborder="0"></iframe>

Starlink’s growth across the continent remains modest but accelerating. In Zimbabwe, subscriptions [grew](https://example.com/) to 67,057 in Q4 2025, a 31.6% increase from Q3, making it Starlink’s fastest-growing African market. In Kenya, it reached [22,282](https://example.com/) [subscribers](https://example.com/) by December 2025, its highest since launch, yet still ranks eighth among the country’s internet service providers. For context: Safaricom added more new users in a single quarter than Starlink’s entire Kenyan subscriber base.

[**\[Join the H1 2026 SOTIA Report Waitlist Here\]**](https://docs.google.com/forms/d/e/1FAIpQLSfoaM_hBbJ_E3LF55v6aVOeZiBJunwqRgaUMo7JdC2clzNDxg/viewform)

## Competition is coming, and it’s not African
