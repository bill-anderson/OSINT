...
places: [BFA]
topics: [dpi.govtech, gov.policy, dpi.mis, capacity.training]
entities: [[anptic]]
---

# Dématérialisation des procédures administratives: un atelier pour faire le bilan de sa mise en œuvre

*Pour le directeur général de la transformation digitale, Sié Maxime Da, l’atelier va permettre de faire un tour d’horizon de tout ce qui a été fait en matière de dématérialisation des procédures administratives au Burkina Faso.*
