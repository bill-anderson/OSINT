---
type: source
title: "Kenya Digital Economy Acceleration Project"
url: https://projects.worldbank.org/en/projects-operations/project-detail/P170941
...
World Bank Group committed US$390,000,000 to Republic of Kenya (KEN).
...
| Recipient | Republic of Kenya (KEN) |
| Beneficiary type | Government |
| Instrument | Concessional loan *(source label, unverified — see Notes)* |
| Status | Active |
| Commitment (USD) | US$390,000,000 |
| Original amount | USD 390,000,000 |
| Commitment year | 2023 |
| Start year | 2023 |
| End year | 2028 |
| Disbursed (USD) | US$33,931,565 |
| Amount quality | Exact |
| WB DT category | DIGITAL ECONOMY -> infra.connect |
| Digital ID flag | FALSE |
| Digital payments flag | FALSE |
| Project ID | P170941 |
| IATI activity ID | 44000-P170941 |
| Board approval date | 2023-03-31 *(enriched from source, 2026-07-21)* |
| Closing date | 2028-10-31 *(enriched from source, 2026-07-21)* |
| Borrower | Republic of Kenya *(enriched from source, 2026-07-21)* |
| Implementing agency | Information Communications Technology Authority (ICTA), Ministry of Information, Communications and Digital Economy (MIC *(enriched from source, 2026-07-21)* |
...
Accelerates Kenya's digital economy by expanding broadband connectivity, strengthening digital public infrastructure and services, and enhancing digital financial services. Supports the National Digital Master Plan.

## Source

https://projects.worldbank.org/en/projects-operations/project-detail/P170941 - Project portal, accessed 2026-06-24
