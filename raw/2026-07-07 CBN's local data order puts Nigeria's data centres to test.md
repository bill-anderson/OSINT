...
<!-- On-the-record reporting on the CBN data-localization directive + industry-readiness
     debate. Admissible. Reports the same primary as the parked lead
     `raw/_leads/The CBN Data Localization Mandate - Cencori.md` (the CBN circular of
     2026-06-15, deadline 2027-01-01); the circular itself is still to be obtained.
     DC operators (OADC/WIOCC, Rack Centre, Kasi Cloud, Galaxy Backbone, Equinix) and
     hyperscalers (AWS/Azure/Google/IBM) mentioned, not hubbed — figures carried on
     [[NGA]] and [[nigeria--gov-protect]]. -->
...
The answer is high-stakes, given that digital payments have become the absolute backbone of the nation’s economy. [According to data from the Nigeria Inter-Bank Settlement System (NIBSS)](https://nibss-plc.com.ng/nigerias-payment-revolution-how-nibss-cbn-are-building-africas-most-robust-digital-infrastructure/), the value of electronic transactions surged 80% to a record ₦1.07 quadrillion (approx. $702 billion) in 2024, up from ₦600 trillion ($393.6 billion) the previous year, with total volumes climbing to 11.2 billion transactions. Managing a financial engine of this magnitude locally will be the ultimate test for Nigeria’s data centers.
...
That dependence has persisted even as banks sharply increase their digital investments. [Nigeria’s 10 largest banks spent a combined ₦177.91 billion (about $116 million)](https://businessday.ng/market-intelligence/article/banks-ramp-up-digital-push-as-it-spending-rises-by-31/) on information technology in the first quarter of 2026, up 30.8% from ₦136.04 billion ($98.46 million) a year earlier, as they expanded artificial intelligence capabilities, cloud infrastructure and cybersecurity.
...
Nigeria now has about 26 data centre facilities, according to industry [estimates compiled by TechCabal Insights](https://insights.techcabal.com/can-nigerias-data-centres-power-africas-ai-future/). 18 of them are commercial data centres where banks, fintechs, cloud providers, and other businesses rent space for their servers. The rest are private facilities built for organisations such as telecom operators and banks.
...
Johnson Agogbua, co-founder and chief executive of Kasi Cloud, [West Africa’s first hyperscale-ready AI-capable](https://techcabal.com/2026/01/08/will-nigeria-get-its-first-ai-data-centre-in-2026/) data centre, said Nigeria has enough data centre space to support the migration.

“The short answer is yes,” Agogbua told TechCabal via email. “Physical data centre capacity is not the problem.” [Kasi Cloud](https://techcabal.com/2026/02/05/a-first-look-at-kasi-clouds-100mw-ai-data-centre-in-lagos/) is developing a hyperscale data centre campus in Lekki, Lagos, that will scale to about 100MW of critical IT capacity upon full build-out, making it one of the largest data centre developments in Africa.
...
Over the past decade, submarine cables, including MainOne, Glo-1, WACS, ACE, Equiano, and, most recently, 2Africa, have increased international bandwidth into Nigeria. During the widespread cable disruptions in March 2024, [Equiano played a critical role](https://www.internetsociety.org/resources/doc/2024/2024-west-africa-submarine-cable-outage-report/) in maintaining connectivity for many businesses.
...
Equinix has also [expanded outside Lagos with a $22 million Tier III-certified facility](https://newsroom.equinix.com/2025-11-10-Equinix-Announces-Plans-for-New-22-Million-Data-Center-in-Lagos,-Nigeria) in Port Harcourt, signalling a gradual diversification of Nigeria’s data centre footprint.
...
Olubayo Adekanmbi, chief executive of [Data Science Nigeria](https://datasciencenigeria.org/), a non-profit AI and data science organization, believes the policy reflects a broader shift in how governments increasingly view financial data.
...
Power constraints remain significant, broadband coverage is still expanding at [56% penetration](https://ncc.gov.ng/market-data-reports/industry-statistics), and digital infrastructure continues to develop. But he argues these limitations should not delay efforts to establish stronger national control over critical financial infrastructure.
...
[***Get 20% off Early Bird tickets for a limited time***](https://mainstack.com/p/moonshot-by-techcabal-2026/tickets)***.***

![](https://c76c7bbc41.mjedge.net/wp-content/uploads/tc/2026/07/image-16.jpeg)