...
**Staging note (sweep):** **Treat with suspicion.** Every substantive claim here
is the CAR government's own — the piece is built on a government statement plus
a presidential quote, with no independent verification, no named critic, and no
land-administration expert. The framing ("pivotal shift from symbolic
experimentation to real-world impact") is the project's marketing. Primary worth
sourcing at ingest: **the presidential decree itself** enabling the Bossongo
concessions, and the `$CAR` platform's own terms.

**Date conflict flagged:** this piece states `$CAR` "was launched in early 2024".
That contradicts TechCabal (2025-02-11), which reports Touadéra launching `$CAR`
on X in **February 2025** and covers the launch as news of that week. The
TechCabal date is corroborated by the 90%-in-24-hours price collapse it reports.
ITWeb's "early 2024" looks like an error; do not carry it into wiki pages
without resolving.
