---
type: source
title: "China Eximbank provides RMB 3.06 billion \u2018mixed credit\u2019 for 5900 km South Atlantic Inter Link (SAIL) Cable Project"
url: https://www.digitalbusiness.africa/guinee-equatoriale-veut-rejoindre-consortium-cable-marin-cameroun-bresil-forme-de-china-unicom-camtel/ https://www.submarinenetworks.com/en/systems/brazil-africa/sail
...
Export-Import Bank of China committed US$543,750,989 to Government of Cameroon |South Atlantic Inter Link Consortium (XAF).

## Deal record

| Field | Value |
|---|---|
| Deal ID | eximbank-cn-cmr-003 |
| Financier | Export-Import Bank of China |
| Recipient | Government of Cameroon |South Atlantic Inter Link Consortium (XAF) |
| Beneficiary type | Government |
| Instrument | Commercial loan |
| Status | Closed |
| Commitment (USD) | US$543,750,989 |
| Original amount | 3060000000 CNY |
| Co-financiers | Cameroon Telecommunications (CAMTEL)|China United Network Communications Group Co., Ltd. (China Unicom) (CUniq) |
...
Recoded from CMR to REG (continent-to-continent capacity). SAIL is a 5,900 km intercontinental submarine cable from Kribi (Cameroon) to Fortaleza (Brazil); Cameroon is the sole African landing but the cable provides continental-scale capacity that benefits any African ISP buying transit. Treated analogously to other regional cable rows (2Africa, Equiano, East2West). Previous notes: Cross-verified: AidData RMB 3.06B loan (85% of project cost) confirmed by SubmarineNetworks.com, Wikipedia, multiple press sources. Second source: https://www.submarinenetworks.com/en/systems/brazil-africa/sail | AidData staff note: 1. Multiple sources indicate that the debt financing for this project was provided via “Two Excellen
