...
places: [BFA]
topics: [infra.connect, digital.rural, include.divides, include.access, gov.policy, digital.localgov]
entities: [[ministere-transition-digitale-burkina-faso], [arcep-burkina-faso], [nongobzanga-zongo]]
---

# Communications électroniques: le projet de couverture de 750 zones blanches présenté aux acteurs de Nando

*Les participants dont les PDS et leaders coutumiers ont été sollicités pour la sensibilisation des populations…*
