...
date_source: source
ingested: 2026-07-20
places: [XAF, NGA, EGY, KEN, ZAF]
topics: [finance.new, tech.industry, tech.innovate, dpi.pay]
entities: [[disrupt-africa], [african-tech-startups-funding-report], [tom-jackson], [gabriella-mulligan], [tvc-labs]]
body_completeness: full
---

*Primary: Disrupt Africa's own announcement of the 11th edition of its annual African Tech Startups Funding
Report (2026-02-03) — the origin for the CY2025 floor figure the wiki previously held only via ITWeb's
re-report ([[raw/2026-02-27 SA powers Africa's $1.64bn tech funding rebound]]). This is the announcement
...
founded 2007, falls outside it). Partech counts equity __plus debt__, by deal, across a wider universe:
US$4.1bn / 570 deals. Never sum, average or cross-check the two. Two traps: (1) the big-four agreement is a
__false parallel__ — 72.5% here is by __count__ (129/178) against Partech's 72% by __value__; by value this
series puts the big four at __88%__, a __16-point divergence__; (2) Partech's __debt subtotal__ (US$1.64bn)
equals this series' __total__ (US$1.6367bn) by __coincidence, not reconciliation__. The gap localises to
debt megadeals to mature companies: the trackers rank the big four in __opposite orders__ — Kenya is
Partech's #1 (US$1.04bn, 48% debt) but #4 here (US$273.2m), a 3.8x divergence, while equity-shaped Nigeria
differs by only 1.2x (US$572m vs US$464.8m).*

# African tech startup funding leaps by almost 50% as sector begins to recover from global "funding winter"

By Tom Jackson, 3 February 2026

Total investment into the African tech startup ecosystem increased by almost 50 per cent to US$1.64 billion in 2025 as the sector began to slowly recover from the impacts of the global capital shortage.
