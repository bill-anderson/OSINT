...
**Staging note (sweep):** *TechCabal Daily* newsletter digest; only the CAR
segment (reproduced in full below) is in scope — the Nokia/Egypt, Absa/Airtel
and Moov/Benin segments are omitted. Same event as the TechAfrica News item of
the same date, **different outlet, kept per README §2** — and it earns its place:
unlike the ministry-communiqué copy, this one supplies **analysis and the
grey-market context** the official framing omits (users importing kits to beat
the price barrier, the South Africa precedent, "this is about visibility").

**Currency caution:** quotes internet penetration at **15.5%** as of April 2026
— that is the DataReportal **2024** figure recycled; Connecting Africa's
end-2025 DataReportal number is **12%**. Do not carry 15.5% as an April-2026
value. Its kit price (CFA240,000/$400) also differs from ITWeb's and TechAfrica
News's March 2026 figures (see the 2026-03-17 Connecting Africa staging note).
...
## Internet — Central African Republic cracks down on grey market Starlink use
