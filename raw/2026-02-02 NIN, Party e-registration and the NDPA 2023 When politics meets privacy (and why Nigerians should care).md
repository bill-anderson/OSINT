...
A [NIN](https://guardian.ng/technology/tech/beyond-enrollment-how-nimc-is-taking-identity-services-to-nigerias-doorsteps/) is a unique, persistent identifier used across government and private-sector services. In privacy terms, it is not merely a number; it is a key that can link a person across many systems. If stored widely, copied casually, or compromised, a NIN can become an enabler for identity theft, impersonation, SIM-swap attempts, account takeover, and other forms of fraud.
