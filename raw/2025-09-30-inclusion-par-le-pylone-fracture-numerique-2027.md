...
ingested: 2026-07-20
places: [BFA]
topics: [infra.connect, digital.rural, include.access, include.divides, gov.policy, finance.new]
entities: [[bf-ministry-digital-transition], [arcep-burkina-faso], [pactdigital], [onatel], [orange-burkina-faso], [telecel-faso]]
body_completeness: full
---

*Ingested to close a provenance gap: this is the **sole origin** of the "330 zones déjà connectées
depuis 2019" figure. Note the figure appears as an **unattributed closing line by the journalist**,
not as a quoted official statement — at the very same 2025-09-30 Ouahigouya event where minister
Zerbo/Sabané stated **223 sites depuis 2020**. Also carries DG Zongo's 4G-coverage-collapse figure
(53% → 33%).*

Le Mardi 30 septembre 2025 dans la région du Yaadga, le Burkina Faso a lancé le projet « Zéro Zone Blanche » pour étendre la couverture en communications électroniques à 750 zones rurales qui en sont actuellement dépourvues. Cette initiative s'inscrit dans une vision stratégique nationale visant à faire de la transition numérique une priorité.
