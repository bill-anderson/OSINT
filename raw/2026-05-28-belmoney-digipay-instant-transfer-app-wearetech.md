...
# Belmoney, DigiPay launch instant transfer app for Congo and DRC

By: Samira Njoya. Date: jeudi, 28 mai 2026 14:01.

*Sweep note: covers both Congos (COG + COD). Same event as the Connecting Africa account of the same date, different outlet — retained per the sweep dedup rule. This account adds the detail that Belmoney is licensed as a payment institution by the **National Bank of Belgium**, and the RaaS framing.*
