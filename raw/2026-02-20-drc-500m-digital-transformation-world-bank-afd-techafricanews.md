---
type: source
title: DRC Launches $500 Million Digital Transformation with World Bank and AFD Support
url: https://techafricanews.com/2026/02/20/drc-launches-500-million-digital-transformation-with-world-bank-and-afd-support/
...
# DRC Launches $500 Million Digital Transformation with World Bank and AFD Support

*By Joyce Onyeagoro, TechAfrica News, 20 February 2026. (Exa search metadata attributed this to "Jennifer Onyeagoro" — not borne out by the page; the on-page byline is used.)*

*Dedup note: an English-language, different-outlet twin of the We Are Tech Africa report already held ("Numérique : la RDC annonce l'opérationnalisation d'un financement de 500 millions $" → raw/2026-02-20 DRC operationalises $500m partner tranche of PNN2 financing). Retained per the sweep rule that same-event/different-outlet is never a drop; adds the state-data migration, government cybersecurity centre and "AI Sphere" details.*
