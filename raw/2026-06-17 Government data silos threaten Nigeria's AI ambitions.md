---
type: source
title: "Government data silos threaten Nigeria's AI ambitions"
...
The most aggressive push was in 2020 when the [government mandated the linkage of SIM cards](https://techcabal.com/2020/12/18/on-ncc-new-sim-card-regulation/) to National Identification Numbers (NIN), aiming to connect telecom data with verified identities. Yet despite these efforts, institutional rivalries and concerns over data ownership continue to keep many systems running in parallel rather than as part of a unified digital infrastructure.

The stakes have become even higher as Nigeria accelerates its AI ambitions. In 2025, the country [launched a National Artificia](https://ncair.nitda.gov.ng/wp-content/uploads/2025/09/National-Artificial-Intelligence-Strategy-19092025.pdf) l Intelligence Strategy and unveiled N-Atlas, Africa’s first government-backed multilingual large language model. But experts say the challenge is no longer about vision; it is about execution.
...
John Edokpolo, Microsoft’s Head of Legal Affairs for Africa, pointed to countries such as the United Arab Emirates and Singapore as examples.
...
To address this, NITDA said it is working through the [National Cloud Policy](https://nitda.gov.ng/?sdm_process_download=1&download_id=9152) and developing frameworks for data exchange. Yet the process is proving more complex than anticipated.
