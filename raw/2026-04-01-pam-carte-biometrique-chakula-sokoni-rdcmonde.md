---
type: source
title: "Est de la RDC : invention d’un système de paiement par carte biométrique pour maintenir l’aide et soutenir les marchés locaux"
url: https://rdc-monde.com/est-de-la-rdc-invention-dun-systeme-de-paiement-par-carte-biometrique-pour-maintenir-laide-et-soutenir-les-marches-locaux/
...
the WFP "rapport annuel 2025", which dates the underlying evidence, not the article.
Exa metadata suggests 2026-04-27 but is unreliable. The page header renders a
crawl-time site clock ("dimanche, juin 14, 2026") — demonstrably NOT the publication
date, since it differs from Exa's date and varies by crawl. Date set to month
precision (2026-04-01) as a proxy; the month itself rests only on Exa and is uncertain. -->
