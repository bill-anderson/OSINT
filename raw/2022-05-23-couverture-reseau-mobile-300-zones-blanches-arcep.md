...
ingested: 2026-07-20
places: [BFA]
topics: [infra.connect, digital.rural, include.access, include.divides, finance.new]
entities: [[arcep-burkina-faso], [orange-burkina-faso]]
body_completeness: full
---

*Historical baseline (2022) — ingested for its **definitional** content, not as current state. This is
the only held source in which programme officials state the **site-vs-locality ratio directly**: 183
antennas (sites), each ~6 km range, covered ~300 white zones (localities). Event date: field visit
**2022-05-20**; publication 2022-05-23.*
...
Selon le président de l'ARCEP, Tontama Charles Millogo, les réalisations des sites ont soulagé les populations.
...
Sur tous les sites visités, l'équipe de l'ARCEP a pu techniquement apprécier les nouvelles installations.
