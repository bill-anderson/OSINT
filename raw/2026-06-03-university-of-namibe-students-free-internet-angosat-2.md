...
places: [AGO]
topics: [infra.connect, capacity.training, capacity.research, include.access, infra.capacity]
entities: [[angosat-2], [unitel], [airbus]]
---

*(PR-wire item — Tech Review Africa carries no independent reporting on this; the primary is the GGPEN/MINTTICS announcement and should be sourced at ingest if the detail is load-bearing.)*
