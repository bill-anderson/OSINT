...
places: [BFA]
topics: [data.statistics, gov.policy, dpi.mis]
entities: [[pingdwende-gilbert-ouedraogo]]
---

# Système collecte de données statistiques: le ministère en charge de la communication explore les pistes de renforcement du dispositif

*Le ministre chargé de la Communication, Pingdwendé Gilbert Ouédraogo : « l'analyse des performances au cours de l'année 2025 révèle des acquis consolidés malgré un contexte national marqué par des défis multiples ».*
