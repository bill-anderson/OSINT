...
By: Samira Njoya. Date: mercredi, 24 juin 2026 10:42.

*Sweep note — corroborates the re-dating of held material: this piece states the GSMA report was "published on Monday, June 22" [2026], independently confirming the TechAfrica News date of 2026-06-22 against the wiki's held proxy date of 2026-01-01. It also converts FCFA 870bn to ~$1.5bn and adds the fiscal-impact figures. The French twin on the same outlet (`/fr/fils/actualites/tech/congo-1-5-milliard-et-144-000-emplois-grace-au-numerique-d-ici-2030-gsma`, 2026-06-24) was dropped as a same-outlet re-crawl.*
