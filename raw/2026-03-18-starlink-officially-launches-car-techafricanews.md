...
**Staging note (sweep):** Same event as Connecting Africa (2026-03-17) and ITWeb
(2026-03-19) — different outlets, kept per README §2. **Uniquely supplies the
launch date (16 March 2026) and venue** (Digital Training Center, University of
Bangui) and the most precise kit pricing (excl. tax). Names **DEVEA
CENTRAFRIQUE** as Starlink's local representative and **Parfait Kowosso** as a
speaker — neither has a wiki page.

**Byline caution:** Exa metadata gave "Jennifer Onyeagoro"; the page byline is
**Joyce Onyeagoro**. The page is authoritative — this is exactly the
techafricanews byline unreliability the sweep brief warns about, and the two
names differ by first name only, so it would be easy to miss.

# Starlink Officially Launches in the Central African Republic to Boost High-Speed Internet Access
