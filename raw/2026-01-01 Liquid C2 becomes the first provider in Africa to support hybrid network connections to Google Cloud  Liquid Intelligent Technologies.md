---
type: source
title: "Liquid C2 becomes the first provider in Africa to support hybrid connections to Google Cloud"
publisher: Liquid Intelligent Technologies
...
<!-- First-party: Liquid C2 first Google Cloud Interconnect provider on the continent (private
     hybrid links, less public-internet reliance). Quoted: Oswald Jumira (CEO Liquid C2).
     UNDATED — sequenced after the 2024 root deal. -->

# Liquid C2 becomes the first provider in Africa to support hybrid network connections to Google Cloud | Liquid Intelligent Technologies

> ## Excerpt
> Liquid Intelligent Technologies, is pleased to announce that it has become the first Google Cloud Interconnect provider on the continent.
