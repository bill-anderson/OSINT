...
date_source: source
places: [CAF]
topics: [infra.connect, include.access, include.divides, finance.mou]
...
(`/en/fils-uk/news/telecom/orange-launches-4g-in-key-central-african-cities-...`,
same date, same author). The FR original is kept as canonical; the EN twin is
logged as a same-outlet re-crawl in the drop log.

# RCA : Orange lance la 4G pour répondre à la demande croissante en connectivité

Par : Samira Njoya
Date de création : lundi, 19 mai 2025 07:56
...
> 🚨🚨 COMMUNIQUÉ DE PRESSE — Nous annonçons le lancement officiel de la 4G en République Centrafricaine. 🇨🇫 #OrangeAKeDa #4GAKeDa #Réseau #Connexion #RCA
