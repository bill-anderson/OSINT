...
ingested: 2026-07-17
places: [ZAF]
topics: [dpi.id, gov.standards, include.access, infra.cybersec]
entities: [[home-affairs-south-africa], [leon-schreiber], [idemia]]
---

*A PLAN, NOT AN ACCOMPLISHED FACT — and its 'full implementation targeted for 2025' was not met. Second-hand (footer credits BizNews). The earliest of the Smart ID chain and the announcement the later items deliver against. Carries IDEMIA's 10-year contract to upgrade SA's ID system including provision of 80 million smart ID cards — which appears nowhere on the held south-africa--dpi-id despite IDEMIA having an entity page.*

South Africa's Department of Home Affairs (DHA) has unveiled comprehensive plans to expand its national smart ID card system in 2025, including widespread accessibility improvements and enhanced security features.
...
The push to phase out older green ID books is supported by recent fraud analysis, with Smile ID's 2024 Digital Identity Fraud report identifying South Africa's green ID book as the continent's most frequently targeted identity document for fraud.
