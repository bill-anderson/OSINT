...
**Staging note (sweep):** Tech Review Africa is the PR-wire lead-net outlet
(README source table). Date **not available to search** — established from the
page body ("Date: 2026-05-14"), which also supplied a byline (**Robert Kwaku
Annor**) that Exa reported as absent. Content is a launch-event notice with no
subscriber numbers, coverage figures or pricing, and the only "analysis" is
unattributed ("stakeholders emphasized"). Primary worth sourcing at ingest:
**Telecel Centrafrique / Telecel Group's own launch release**; Ecofin Agency and
the Ghana Chamber of Telecommunications also carried this story (~2026-05-18),
and a fuller account may exist there.

**Why it's new:** the wiki records Telecel only as a bare operator name on the
CAF page. This dates Telecel's **4G+ commercial launch (14 May 2026)**, roughly
a year behind Orange (15 May 2025), and follows Telecel's own **4G licence
award of 22 Dec 2025** — making CAR a genuinely contested 4G market for the
first time. Neither the licence nor the launch is held.
