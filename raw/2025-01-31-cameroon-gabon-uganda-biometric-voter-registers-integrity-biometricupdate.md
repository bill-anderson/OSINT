...
<!-- Note for ingest: the **hardest inclusion-harm evidence in the CMR sweep**, and the one
     item here that bites on rights rather than infrastructure. Dated facts: the 2025 annual
     biometric voter registration cycle opened **6 Jan 2025** with an ELECAM target of **≥8
     million** names; **~12,000 registered voters** were reportedly struck from the register in
     a Dec-2024 database clean-up over **rejected fingerprints**; opposition figure Maurice
     Kamto alleges this was a scheme to exclude opposition voters; ELECAM said it would remedy
     it. The piece attributes the rejections partly to **poor capture on registration kits in
     use since 2012** — i.e. a biometric failure mode with a direct disenfranchisement
     consequence. Also: **755,000+** new voters registered in 2024.

     This is the causal antecedent of the staged newspaper item
     `2025-05-08-lejour-elecam-acquires-1000-biometric-enrolment-kits.md` — the kit purchase
     answers the ageing-kit problem described here. Link the two at ingest.

     Sourcing note: multi-country round-up; the Cameroon section rests on Stopblablacam citing
     **unnamed internal ELECAM sources** for the retraining plan (the 12,000-voter and 8m
     figures are more solidly reported). Attribute the retraining plan cautiously. The GAB and
     UGA sections rest on VOA and The Observer respectively. Tagged GAB and UGA as well as CMR
     since each carries its own dated development. -->

# Cameroon, Gabon, Uganda tackle biometric voter registers' integrity, engagement

*By Ayang Macdonald — January 31, 2025*
