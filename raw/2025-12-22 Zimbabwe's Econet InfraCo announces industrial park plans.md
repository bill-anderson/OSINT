...
ingested: 2026-07-17
places: [ZWE]
topics: [infra.store, infra.energy, tech.industry, infra.connect]
entities: [[econet-infraco], [econet-wireless], [strive-masiyiwa]]
---

*Same 300-hectare Harare airport project as the ITWeb account, and complementary rather than duplicative: uniquely carries the phased demand-led rollout, that phase 1 has apparently already begun, the 'largest private-sector development since independence' framing, and the explicit note that data-centre capacity is NOT disclosed. Hedged and downstream ('local newspaper reports say', 'apparently') — attribute. Contradicts ITWeb on whether InfraCo is new; this account attributes its version to the company itself.*
