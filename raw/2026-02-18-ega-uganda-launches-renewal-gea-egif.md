---
type: source
title: Uganda launches renewal of its government enterprise architecture and e-government interoperability framework
url: https://ega.ee/uganda-renewal-government-enterprise-architecture-interoperability-framework/
publisher: e-Governance Academy (eGA)
published: 2026-02-18
date_precision: day
date_source: source
places: [UGA]
topics: [dpi.exchange, gov.standards, dpi.govtech, digital.localgov, geopol.eu]
entities: [[nita-uganda], [e-governance-academy], [uganda-e-gif], [world-bank]]
lens: []
...
*Reconcile-pass primary (2026-07-20). Establishes the date of the GEA/e-GIF renewal workshop.
eGA is the implementing partner — the announcer of record. **Ingested 2026-07-20 as a
`replace`:** it displaces the secondary re-report
`2026-02-19 NITA-Uganda concludes workshop on renewal of government enterprise architecture and
interoperability framework` (TechReviewAfrica), which was retired on ingest — same event, no
unique payload, and this is the primary. Citations rewired; the retired file's
`digital.localgov` / `geopol.eu` facets are carried here.*
