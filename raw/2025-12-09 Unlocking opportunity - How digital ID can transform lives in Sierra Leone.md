---
type: source
title: Unlocking opportunity - How digital ID can transform lives in Sierra Leone
url: https://blogs.worldbank.org/en/africacan/unlocking-opportunity-how-digital-id-can-transform-lives-in-sierra-leone
publisher: World Bank Blogs — Africa Can End Poverty
author: Jana Kunicová, Tahir Bockarie, Hyea Won Lee
...
> ## Excerpt
> World Bank analysis of Sierra Leone's DPI: 6.4m people hold a national ID number (~8 in 10), targeting universal coverage of 8.8m, but fewer than half a million ID cards issued as of 2024 — a $6-7 fee prices most out. Flags the absent data-protection framework and siloed systems as the binding constraint; notes 35,000 households paid via mobile in a recent emergency cash transfer (a first).
...
Key lessons from Sierra Leone's ID journey:
...
Sierra Leone's ambition to scale digital ID under the Big 5 Game Changers is bold yet achievable. Priorities include: strengthen governance for institutional coordination and a secure, trusted ID system; invest in universal access through mass registration drives, mobile outreach, and affordable ID pricing; build robust civil registration and ID systems with capacity to scale; expand a whole-of-government approach with shared standards, digital verification use cases, and tiered authentication; and scale private sector ID use cases, such as digital payments through the instant payments switch.

Public awareness is critical, especially for reaching marginalized groups. As Sierra Leone strengthens its digital public infrastructure, continued investment in energy and digital connectivity will be crucial. Building on the Bank's support for solar home systems in 500 schools and 200 health facilities, expanding access to electricity and the internet can unlock digital services for more people and communities.
