...
*DATE COULD NOT BE ESTABLISHED — the honest fallback. The clip's published field is empty, the body carries no date, and the URL has no date path. Per the fallback chain the date defaults to the INGEST date and is marked proxy; it is NOT a publication date and the file's sort position is meaningless. The true date may be materially earlier. See GAP-UGA-004.*
