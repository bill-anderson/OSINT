...
<!-- Byline and date established from the fetched page, which carries an in-body line
     "By : Samira Njoya / Date : vendredi, 29 mai 2026 14:09". Agrees with Exa metadata. -->

<!-- Note for ingest: an energy story, but squarely in scope as **data infrastructure** — AMI
     smart metering is population-scale automated data capture, and the piece reports a
     **data centre under construction in Douala** to centralise and secure the meter data.
     That data centre belongs alongside the CENADI / Zamengoe / ST Digital material rather
     than being read as a purely utility matter.

     Names worth checking at ingest: the piece calls the national electricity company
     **"Socadel (formerly Eneo)"**. The wiki carries Eneo; if the rename is real it needs
     recording with a date, and if it is the outlet's error it needs correcting — no other
     staged CMR source mentions Socadel. Treat as unverified pending a second source.

     Dated figures: 20,000 meters; PRSEC 2024–2026 valued at ~CFA400bn ($710m), of which
     CFA180bn World Bank and CFA48bn AfDB; 50,000+ wooden poles to be replaced; 1.5 million
     postpaid customers to migrate to prepaid. Trials Jan–Feb 2026, final acceptance April 2026. -->

# Cameroon begins rollout of 20,000 smart meters

*By: Samira Njoya — Date: vendredi, 29 mai 2026 14:09*
