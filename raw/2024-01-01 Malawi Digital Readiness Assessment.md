...
Government-pillar recommendations include establishing a centralized Digital Transformation authority, empowering the Department of E-Government, and expanding MACRA's regulatory mandate; the DRA is framed as the entry point to a National Digital Transformation Strategy and Roadmap. (Flagged: hosted on a demo/preview domain; no explicit publication date — dated by proxy to 2024, when UNDP records the DRA as conducted under the IDT4M programme.)
