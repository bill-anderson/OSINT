---
type: source
title: DR Congo Signs Agreement to Deploy National ID System
url: https://www.wearetech.africa/en/fils-uk/news/tech/dr-congo-signs-agreement-to-deploy-national-id-system
...
# DR Congo Signs Agreement to Deploy National ID System

*By Samira Njoya, editing by Sèna D. B. de Sodji, We Are Tech Africa. Date : vendredi, 14 février 2025 12:13.*

*Dedup note: We Are Tech also ran a French-language version of this same story on the same date ("La RDC déploie un système national d'identité numérique avec Trident Digital Tech"); that FR twin was dropped as a same-outlet re-crawl and logged. Different-outlet twin: Biometric Update, 13 February 2025 (already held).*

*Analytical value: notes that Trident's statement **did not detail the company's specific roles** — an early provenance gap in a concession the wiki tracks as its most externalised national-ID build.*
