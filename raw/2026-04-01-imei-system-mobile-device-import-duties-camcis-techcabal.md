...
<!-- Note for ingest: the fullest account of the IMEI regime's *mechanics and legal basis* —
     grounded in **Article 6 of the 2023 Finance Law**, and explicitly **not a new tax**.
     Uniquely supplies: the revenue-loss estimate (**~$21.5 million annually** from undeclared
     devices, per Customs); the **fiscal amnesty** for devices already on-network before
     1 Apr 2026; roaming/tourist and temporary-admission exemptions; the **two-month window**
     for distributors to regularise existing stock; vendor liability for enabling customs-status
     checks; and the officials' framing of the scheme as a **"digital border"**. Also names
     IMEI duplication as a target, which is the traceability rationale rather than the revenue
     one.

     Figure to reconcile at ingest: this piece has Customs estimating **~$21.5m/yr** in losses,
     while the staged 2026-05-22 ITWeb item projects **CFA25bn/yr** (~$41m) in collections
     against CFA1.3bn before. These are different quantities (leakage vs projected take), so
     probably not a contradiction — but do not conflate them. -->

# Cameroon rolls out IMEI-based system to enforce import duties on mobile devices

*By John Adoyi — 1st Apr, 2026*
