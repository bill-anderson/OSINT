---
type: source
title: "Solly Malatsi | Removing smartphone tax means access to opportunity"
url: https://www.sowetan.co.za/opinion/columnists/2026-07-10-solly-malatsi-removing-smartphone-tax-means-access-to-opportunity/
publisher: Sowetan (opinion / columnists)
author: Solly Malatsi
...
> ## Excerpt
> A smartphone is not just a device; it is access to opportunity.

> **Provenance note.** First-hand opinion column **by the sitting minister** (Solly Malatsi,
> Communications & Digital Technologies), published in Sowetan — on-the-record ministerial
> commentary, cite as his framing. Impact figures are attributed to the GSMA report
> *"Accelerating Smartphone Adoption through Tax Reform: Evidence from South Africa"*
> (`[[gsma-sa-smartphone-tax-reform-2026]]`), which the wiki does not yet hold as a primary —
> verify the figures against it.
...
Every additional smartphone sold represents another person who can: apply for a job online; submit a university application; access learning materials; advertise a small business; use online banking; or communicate with government without travelling long distances.
...
Another key finding of the GSMA report was that making smartphones more affordable did not come at the expense of economic growth. The report found that the value of South Africa's smartphone sales increased from R2.7bn to R3.1bn per month following the tax reform. This fact shows us that good public policy does not have to choose between economic growth and social progress.
...
Where government can act, we must do so to create the conditions that make access to opportunity possible. We can do this by: removing unnecessary barriers; enabling investment; and ensuring that more people can participate in the opportunities created by technology.

The GSMA report shows us that the removal of the luxury tax on entry-level smartphones is one example of that approach in action. While our work is far from finished, we remain focused on improving device affordability and expanding connectivity.
