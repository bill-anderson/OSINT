...
Satellite is not the last resort anymore. It is becoming the backbone of what comes next. That was a key message in my conversation on [Episode Five, Season Two](https://techafricanews.com/2026/03/18/ep-05-s2-could-satellites-free-africa-from-network-limits-st-engineering-idirect-on-multi-orbit-connectivity/) of TechAfrica News Podcast with **Omar Diab, Regional Vice President of Sales for the Middle East and Africa** at [**ST Engineering iDirect**](https://www.idirect.net/). It was not framed as a grand declaration, but it surfaced consistently throughout our discussion: the role of satellites in Africa has fundamentally changed, and with it, the logic of connectivity itself.
