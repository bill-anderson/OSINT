---
type: source
title: Nigeria ties crypto to tax via TIN and NIN (NTAA 2025, aligning with OECD CARF)
url: https://techcabal.com/2026/01/12/nigeria-crypto-tax-tin-nin/
publisher: TechCabal
...
ingested: 2026-07-19
places: [NGA]
topics: [dpi.pay, dpi.id, gov.legislate]
entities: [[nrs]]
lens: []
...
Your TIN and NIN are now the bridge between crypto and tax Happily Authenticated!

How Nigeria plans to trace crypto money without cracking the blockchain

Temitayo Jaiyeola 12th Jan, 2026 Get TC updates in your Newsfeed
...
ANNUAL CRYPTO INVESTMENT (COST) 💸 ₦ TOTAL REALIZED PROFIT 📈 ₦

YOUR EXCHANGE’S MONTHLY REPORT INCLUDES:

Full Name & Address Valid TIN & NIN Naira Value of Trades Counterparty Identity Source: NTAA 2025 Sec. 25 & ISA 2025. Non-compliance penalty: ₦10M.

This is not Nigeria’s first attempt at taxing crypto profits. The Finance Act of 2022 introduced a 10% tax on profits from digital assets, but enforcement proved difficult in an ecosystem where transactions were hard to link to individuals.

The NTAA attempts to close that gap. VASPs must now register with tax authorities, while crypto traders are expected to self-report profits, which fall under personal income tax.

“A taxable person engaged in virtual asset activities shall keep records and books as provided under section 31 of this Act and report virtual asset activities to the relevant tax authorities,” the law noted.

The compulsory use of TINs and NINs—already required for operating a bank account—adds a layer of scrutiny that did not exist before. What once operated in regulatory grey zones is being pulled into a tightly monitored system.

This tax push also aligns with broader regulatory changes. In March 2025, Nigeria’s Investment and Securities Act (ISA) 2025 formally recognised virtual and digital assets as securities, bringing VASPs, Digital Asset Operators (DAOPs), and Digital Asset Exchanges (DAXs) under the Securities and Exchange Commission’s (SEC) oversight.

Non-compliant VASPs face penalties of ₦10 million ($7,026.57) in the first month of default and ₦1 million ($702.66) for each subsequent month, alongside the risk of licence suspension or revocation.

Nigeria’s new tax laws are the most sweeping the country has seen in decades. By forcing crypto service providers to report TINs and NINs alongside transaction data, tax authorities are no longer passive observers of digital finance. They can now connect crypto trades to real people, existing income records, and past filings. In doing so, crypto shifts from a largely opaque activity into one that can be traced, cross-checked, audited, and taxed.

Weekend Features Their parents lost fortunes. They’re buying Nigerian stocks anyway.

News Nigeria’s central bank wants every retail dollar traced with digital tracker

Analysis This Nigerian microfinance bank’s slow-lending strategy is delivering fast results
