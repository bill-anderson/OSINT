...
places: [AGO, MOZ]
topics: [gov.regional, finance.mou, infra.connect, data.satellite]
entities: [[angosat-2]]
---

*(PR-wire item — Tech Review Africa carries no independent reporting on this; the primaries are the MINTTICS / Mozambique Ministry of Communications announcements and should be sourced at ingest if the detail is load-bearing.)*
