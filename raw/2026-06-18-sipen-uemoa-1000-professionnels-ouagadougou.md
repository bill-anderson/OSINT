...
places: [BFA, XWA]
topics: [tech.ai, tech.industry, dpi.pay, gov.regional, gov.policy, finance.new]
entities: [[sipen-uemoa], [uemoa], [ministere-transition-digitale-burkina-faso], [aminata-zerbo-sabane], [federation-des-acteurs-du-numerique-burkina-faso]]
---

# Economie numérique dans l’espace UEMOA : 1000 professionnels attendus en juillet prochain à Ouagadougou

Pour le président de la fédération des acteurs du numérique du Burkina Faso, Georges Évariste Tassembedo, la déclaration de Ouagadougou va tracer les sillons du développement numérique dans l’espace UEMOA.
