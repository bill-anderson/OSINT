---
type: source
title: Sierra Leone reaches 93 percent national ID coverage, 80 percent services digitized
url: https://www.biometricupdate.com/202506/sierra-leone-reaches-93-percent-national-id-coverage-80-percent-services-digitized
...
> ## Excerpt
> NCRA reports 93% civil-registration/national-ID coverage and 80% of services digitized (ID4Africa 2025 AGM, June 2025); NIN now required to open a bank account, enrol in public education, or take up public/private employment. ~30% of paper records linked to digital records so far.

---

Sierra Leone says it has recorded a 93 percent civil registration and national ID issuance coverage rate, with at least 80 percent of services already digitized.
...
He adds that having a high ID coverage rate is important, but it is also necessary to ensure system interoperability to make sure that government entities can interact seamlessly with each other.
...
All of the strides so far achieved by the NCRA would not be possible if there were no strong political will, the NCRA deputy ICT chief said. Added to this are intentional reforms which have been carried out to make things easier.
