...
# Congo Nears Completion of Landmark National Data Center, Aims for November 2025 Launch

August 7, 2025. Author: Joyce Onyeagoro.

*Sweep note — outlet error, verified COG not COD: the body's opening line reads "DRC is set to unveil its first National Data Center" and the Ibombo pull-quote is captioned "…Minister of Posts, Telecommunications and the Digital Economy, DRC". Both are TechAfrica News errors. Every substantive detail — Brazzaville's second arrondissement, the AfDB financing, Léon Juste Ibombo, President Denis Sassou N'Guesso's State of the Nation address — is Republic of Congo (COG). Filed to COG; the "DRC" strings are the outlet's, preserved verbatim below.*
...
– Léon Juste Ibombo, Minister of Posts, Telecommunications and the Digital Economy, DRC [sic — outlet error; Ibombo is the Republic of Congo minister]
