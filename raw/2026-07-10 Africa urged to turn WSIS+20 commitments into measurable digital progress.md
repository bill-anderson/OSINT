...
*African stakeholders urged governments to move beyond digital policy commitments by investing in infrastructure, digital skills, AI capacity, and measurable implementation to turn the WSIS+20 vision into tangible progress across the continent.*

African policymakers, civil society leaders, academics, and technology experts used a [WSIS Forum 2026 session](https://dig.watch/event/wsis-forum-2026/wsis20-outcome-document-fostering-digital-transformation-in-africa) to argue that the continent already has the strategies needed for digital transformation but now faces a more pressing challenge: implementation. Organised by the Africa ICT Alliance (AFICTA) and Nigeria’s National Information Technology Development Agency (NITDA), the discussion focused on how the WSIS+20 outcome document can help translate global digital commitments into practical action across Africa.
...
[Afework Temtime](https://et.linkedin.com/in/afework-temtime), of the [UN Economic Commission for Africa (UNECA)](https://www.uneca.org/), argued that Africa does not suffer from a lack of digital frameworks, but from the absence of coordinated implementation.
...
The roadmap identifies major obstacles to digital transformation, including limited connectivity, financing shortages, digital skills gaps, weak regulatory harmonisation, [data governance](https://dig.watch/topics/data-governance) challenges, and insufficient institutional coordination. It also proposes policy actions to address these issues while aligning national efforts with broader initiatives such as the [Global Digital Compact](https://www.un.org/digital-emerging-technologies/global-digital-compact) and the African Union’s [Agenda 2063](https://au.int/en/agenda2063/overview).
...
Representing [NITDA](https://nitda.gov.ng/), Acting Director-General [Dr Dimie Shively Wariowei](https://nitda.gov.ng/dimie-shively-warowei-phd/) outlined Nigeria’s efforts to implement the WSIS+20 agenda through national reforms and capacity-building initiatives.

He noted that the ICT sector now contributes between 13% and 14% of Nigeria’s GDP and highlighted several recent initiatives, including reforms to the [National Identity Management Act](https://ngfrepository.org.ng:8443/bitstream/123456789/946/3/NATIONAL-IDENTITY-MANAGEMENT-COMMISSION-ACT.pdf), broader digital government reforms, and the [3 Million Technical Talents (3MTT) programme](https://3mtt.nitda.gov.ng/), which aims to train three million people in emerging digital technologies by 2027.

Wariowei also pointed to Nigeria’s leadership role in the [Digital Economy Accelerator Programme (DEAP)](https://msmeafricaonline.com/call-for-applications-nitda-digital-export-acceleration-program-deap-pilot-cohort-secure-global-market-access-export-readiness-support-mentorship/), which seeks to coordinate digital transformation efforts across Africa through regional cooperation.
...
[Christiana Onoja](https://www.linkedin.com/in/christiana-onoja/), co-founder and CEO of SheCode.ai, argued that Africa has no shortage of digital ambition, but lacks three critical ingredients: accessible computing infrastructure, locally developed AI, and reliable measurement of progress.
...
‘This is not just an [infrastructure](https://dig.watch/topics/infrastructure) problem,’ she argued. ‘It is a question of power.’
...
To strengthen accountability, Onoja proposed creating a WSIS Implementation Maturity Index covering all 11 [WSIS Action Lines](https://www.itu.int/net/wsis/stocktaking/help-action-lines.html), allowing governments to measure outcomes rather than simply counting workshops, policies, or declarations.
...
[Martha Alade](https://ng.linkedin.com/in/alademartha), President of [Women in Technology in Nigeria (WITIN)](https://witin.org/), said her organisation has reached more than 1.25 million beneficiaries through community-based STEM education programmes across [Nigeria](https://dig.watch/countries/nigeria), including conflict-affected regions.
...
[Evangeline Iwenjiora](https://www.linkedin.com/in/ambevaiwnejiora/) of the Ivyline Care Foundation echoed these concerns, emphasising that women in rural communities remain excluded by poor connectivity and unreliable electricity.
...
Professor [Abayomi Jegede](https://www.maratto.africa/people/abayomi-jegede-1e0f01) highlighted progress within Nigeria’s higher education sector, including curriculum reforms that have expanded specialised programmes in AI, [cybersecurity](https://dig.watch/topics/cybersecurity), data science, and related disciplines.
...
***Track all key moments from the WSIS Forum 2026 on our [dedicated WSIS page](https://dig.watch/event/wsis-forum-2026).***
