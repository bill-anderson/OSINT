...
<!-- EXPERT ANALYSIS / COMMENTARY (Data Landscapers, author [[bill]]). Uses Cassava/Masiyiwa to
     test where pragmatic hyperscaler engagement ends and sovereignty forfeiture begins:
     Cassava's stack is African only at the app layer; chips (NVIDIA), cloud and models are US
     and CLOUD-Act-reachable. Ingested for the ANALYSIS; underlying facts trace to their
     primaries (already-ingested Cassava/Liquid/Anthropic sources). -->
...
The chips are NVIDIA’s. Every GPU in every factory comes from one company, and since November 2025 [that company is also a shareholder in Cassava](https://data-landscapers.com/2026/05/20/google-in-africa/). A supplier and investor wrapped up in one. NVIDIA’s investment is very probably the reason the factories will be built at all, so this is as much an enabler as a dependency; but it means the layer on which everything rests answers to a single foreign firm.
...
None of this is accidental. Google is pursuing continental scale along two tracks at once, as we set out in our earlier piece on [*Google in Africa*](https://data-landscapers.com/2026/05/20/google-in-africa/). One is commercial: the Equiano and Umoja subsea cables, the Johannesburg cloud region, the enterprise and government customers, the consumer push behind Gemini. The other is institutional: framework agreements with the African Union Commission, the UN Economic Commission for Africa, the AfCFTA Secretariat and Smart Africa, and seats on the very bodies now drafting the continent’s AI and data rules. The first track sells the products; the second helps shape the rules the products will be sold under.
