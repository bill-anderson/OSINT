---
type: source
title: "What Google's latest startup cohort says about AI in Africa"
...
This year’s cohort arrives amid growing debate over whether [Africa can turn AI adoption into sustainable, venture-scale businesses](https://www.cnbcafrica.com/media/7779123576869/pwc-africas-ai-challenge-is-scale-not-adoption).

The selected startups offer a snapshot of that transition. [Founders are moving beyond experimentation](https://insights.techcabal.com/africas-ai-builders-207-startups-and-one-continents-bet/) and using the technology to solve operational challenges and build products for local markets. Yet the infrastructure and capital needed to scale those businesses remain in short supply.

In an interview with TechCabal, [Alex Okosi](https://techcabal.com/2023/09/08/what-we-know-about-alex-okosi-googles-managing-director-for-africa/), Google’s managing director for Africa, said African startups have already embraced AI, but argued that investment has not kept pace. While founders are building AI-powered products and services, the continent still faces gaps in cloud infrastructure, data centre capacity and funding. Those constraints, he said, risk limiting Africa’s ability to capture the economic value created by the technology.

AI could add as much as $1.5 trillion to Africa’s economy by 2035, equivalent to roughly 40% of the continent’s current GDP, if governments and private sector players move fast enough to deploy it at scale, [according to projections from the African Development Bank](https://www.afdb.org/en/news-and-events/press-releases/africas-ai-revolution-african-development-bank-report-projects-1-trillion-additional-gdp-2035-use-ai-enhance-productivity-89619). The technology, the bank estimates, could generate hundreds of thousands of jobs while significantly lifting labour productivity across key sectors.
...
That’s why we’re continuing to invest in AI skills development. In 2024, we announced [a $5.8 million grant programme across Kenya, Nigeria and South Africa](https://tech-ish.com/2024/10/29/google-africa-ai-cybersecurity-support/) to help civil servants and nonprofit leaders build AI capabilities. Through Google.org, we’re also focused on AI skilling across Africa, and last year we [pledged another $7.5 million](https://blog.google/intl/en-africa/company-news/outreach-and-initiatives/a-new-blueprint-to-empower-africas-next-generation-of-ai-builders/) to work with partners to expand AI training across the continent.
...
Over the years, we’ve supported more than 190 startups across 17 African markets through the programme. Those companies have gone on to [raise more than $300 million](https://kenyanwallstreet.com/google-picks-two-kenyan-startups-for-ai-focused-accelerator) and created thousands of jobs.
