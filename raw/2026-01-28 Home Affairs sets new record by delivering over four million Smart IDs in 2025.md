...
entities: [[home-affairs-south-africa], [leon-schreiber], [government-printing-works]]
---

*KEEPER of a relevant-duplicate pair: the wiki held an SAnews re-render of this same statement (2026-01-29) with identical payload down to the same Schreiber quote. This is the DHA's own statement and a day earlier, so it wins the lint #7 ladder on both (a) primary and (c) earliest. The held SAnews copy is pruned and its citations rewired here. Striking juxtaposition worth noting: this triumph statement and the SCA exclusion litigation were published on consecutive days.*
