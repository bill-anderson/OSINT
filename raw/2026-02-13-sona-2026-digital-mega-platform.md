---
type: source
title: Ramaphosa champions digital mega-platform at SONA 2026 - Hypertext
...
South Africans will be able to sign up on the digital platform using their IDs and biometrics, and then be able to access digital services like applying for NSFAS funding, renewing driving licenses, receiving a copy of their matric certificates, applying to universities and for public job positions.

It will make sites like eNaTIS, NSFAS online portal and many other websites that currently cost government departments considerable support fees obsolete, and it will be entirely accessible through smartphones.

“Many services, such as grant applications, business registrations, and license renewals, can be done online, with only the final steps like biometric verification requiring limited in person interactions,” the MyMzansi site explains.

In a message on the site, Ramaphosa says, “In recent years, the government has taken important steps to improve the quality of and access to services. Digital platforms have expanded in many areas, making it possible to file taxes, apply for grants and access some services online.”

“Information is hard to find, processes are often duplicated and some departments still operate in ways that are incompatible with the digital age and the evolving expectations of citizens. These issues affect everyone, but they are most challenging for the poor and those who reside far from government service centres,” he adds.
...
The site is currently in the first phase, which will last until February 2027. This phase is essentially about gathering the right personnel and infrastructure to support the platform. The second phase will begin in March 2027 and end in 2030, when the platform is expected to be fully up and running, according to a roadmap found on the website.

This will begin with scaling the existing infrastructure and begin delivering on the services, starting with digital identity verification, data exchange operations, the establishment of a digital payment system, and finally coordinating with government departments to begin rolling out services.
...
According to the Department of Planning, Monitoring and Evaluation, “The coordination and collaboration problems facing the various spheres of government are complex and context specific legislation can provide a guiding framework, but it cannot resolve all coordination issues.”

“The challenges of managing concurrent functions have led to calls for a review of the constitutional responsibilities of the different spheres of government.”

Any opening of tenders for MyMzansi will also immediately fall under the microscope over the breadth and complexity of the plan. Digital tenders awarded by the government have often been extremely costly, and there are numerous examples of failed implementations that waste billions of taxpayers’ Rands.
