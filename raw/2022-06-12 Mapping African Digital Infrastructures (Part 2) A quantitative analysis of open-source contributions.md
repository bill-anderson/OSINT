...
The current literature on analyses of African participation in global digital infrastructure reveals very low open-source contribution levels from the continent. The most up-to-date analysis from GitHub’s “ [State of the Octoverse](https://octoverse.github.com/#geographical-distribution-of-active-users) ” in 2021 showed that Africa has only 2.3% of the active users (users making active contributions) on Github compared to, for example, North America with 31.5% of the contributions.
...
There are also many obstacles faced by African open-source contributors. Apart from a lack of good digital infrastructure and skills, authors face geographical bias towards their contributions – the probability of accepting an open-source contribution [increases by 19%](https://repository.iiitd.edu.in/jspui/handle/123456789/388) when the submitter and integrator are from the same geographical location.
...
This blog is the second in a series of blog posts on mapping African open-source digital infrastructures, highlighting that most digital infrastructure projects are being developed in the Global North and address issues relevant in developed countries. This series of blog posts evaluates the current status of open-source digital infrastructures in Africa and attempts to understand the barriers to uptake and production of digital infrastructures on the African continent. (See [Mapping African Digital Infrastructures (Part 1): A qualitative analysis of open source contributions](https://researchictafrica.net/2022/05/30/mapping-african-digital-infrastructures-a-qualitative-analysis-of-open-source-contributions/) and [Mapping African Digital Infrastructures (Part 3): Understanding the motivations and challenges of African contributions to the Internet standards development](https://researchictafrica.net/2022/06/13/mapping-african-digital-infrastructures-part-3-understanding-the-motivations-and-challenges-of-african-contributions-to-the-internet-standards-development/)).