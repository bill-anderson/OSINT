---
type: source
title: "Cybersécurité : des experts de la sous-région renforcent les stratégies de riposte"
url: https://www.adiac-congo.com/content/cybersecurite-des-experts-de-la-sous-region-renforcent-les-strategies-de-riposte-165608
...
places: [COG, XCA]
topics: [infra.cybersec, gov.regional, infra.capacity, gov.legislate]
entities: [[anssi-congo], [itu]]
lens: [sovereignty]
body_completeness: full
provenance_flag: state-aligned-outlet
---

# Cybersécurité : des experts de la sous-région renforcent les stratégies de riposte

*Les Dépêches de Brazzaville / adiac-congo.com — Mardi 1 Juillet 2025 - 19:34. Par Firmin Oyé.*
...
« En 2025, le coût global de la cybercriminalité est de 9500 milliards de dollars. L'Afrique enregistre en moyenne 3370 cyberattaques par semaine par organisation, avec une croissance de plus de 90% par an. Le continent perd plus de 4 milliards de dollars chaque année à cause de la cybercriminalité », a conclu le minister.

*Légendes et crédits photo : 1-Les officiels posant à l'ouverture des travaux/Adiac 2-Une vue de l'assistance pendant les travaux/Adiac*

---

**Sweep note (not part of the source):** Congo hosted the **13th regional Cyberdrill** (Kintélé, 1–4 July 2025) — an ITU-associated exercise; the wiki records no COG cybersecurity events at all. Places **ANSSI** under the **Conseil national de sécurité** (SG: vice-Amiral Jean Dominique Okemba), which is a meaningful governance fact: the cyber agency sits in the national-security apparatus, not under the ICT ministry — relevant to the `sovereignty` lens. The cybercrime cost figures are quoted by the minister from ITU material; treat as reported-secondhand and verify against the ITU primary rather than promoting from here.
