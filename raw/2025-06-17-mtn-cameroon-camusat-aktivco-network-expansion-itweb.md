...
<!-- Note for ingest: carries the MTN Cameroon capex figure the hub lacks — **$225 million
     pledged over three years**, with the fintech division singled out. Camusat is a French
     infrastructure builder; its energy subsidiary Aktivco supplies the power solutions, which
     ties to the IHS energy-resilience material in the staged 2026-04-16 ART inspections item.
     This ITWeb piece substitutes for the TechAfrica News Camusat/MTN item of 2025-06-11,
     which could not be fetched (logged `fetch-failed` in the drop log) — same partnership,
     different outlet. -->

# MTN Cameroon works with Camusat to expand network

*By Amindeh Blaise Atabong, Contributing journalist, Johannesburg — 17 Jun 2025*

MTN Cameroon has entered into a partnership with Camusat Group, a French telecom infrastructure builder and network developer, through its energy and infrastructure subsidiary Aktivco.
