...
AI is driving scientific discoveries and research breakthroughs, but its progress depends on a global community. To bridge the gap between talent and opportunity, Google DeepMind is launching additional courses of its [AI Research Foundations curriculum](https://www.skills.google/collections/deepmind): advanced AI education designed for the next generation of technical learners across Africa.

## Hands-on experience with generative AI models

The courses, developed with pedagogy experts and academics at University College London — and available at no cost on [Google Skills](https://www.skills.google/collections/deepmind) — give learners the opportunity to build and fine-tune a language model from the ground up. Google.org is supporting the curriculum’s rollout in African classrooms by providing funding for lecturer training and instructional toolkits.
...
One in five people on the planet live in Africa, but only [1.8%](https://www.scimagojr.com/countryrank.php?category=1702) of the contributions to AI research come from the continent. There is an incredible opportunity to bring more African innovation to the table, ensuring that the AI of tomorrow is built by — and for — global communities.
...
Google.org has provided $4 million in funding to the [FATE Foundation](https://fatefoundation.org/). In [partnership](https://fatefoundation.org/aiupskilling/?v=c6a82504ceeb) with the [African Institute for Mathematical Sciences](https://aims.ac.za/) (AIMS), this initiative will bring the online curriculum into classrooms in Africa. This next phase will launch specialized lecturer toolkits and “train-the-trainer” programs, equipping African educators with the resources they need to succeed.
...
Develop your advanced AI research skills today by accessing the no cost curriculum on [Google Skills](https://www.skills.google/collections/deepmind).