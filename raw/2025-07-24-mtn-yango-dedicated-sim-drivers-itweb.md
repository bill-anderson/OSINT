...
<!-- Note for ingest: this piece states plainly that **Yango operates under Russian technology
     company Yandex** — the only such attribution across the CMR holdings, and the fact that
     makes the Yango thread geopolitically legible. The taxonomy has no `geopol.*` slug for
     Russia (only usa/china/eu/india/gulf), so no geopolitical tag is asserted here. Worth
     raising at ingest as a possible vocabulary gap rather than forcing a wrong slug.
     Companion item: the 2026-04-02 ITWeb Yango expansion piece (also staged this pass). -->

# MTN, Yango partner on dedicated SIM offering to drivers

*By Amindeh Blaise Atabong, Contributing journalist, Johannesburg — 24 Jul 2025*
