---
type: source
title: Centrafrique — le HCC dénonce l'usage abusif de l'intelligence artificielle pour la désinformation
url: https://centranews.org/centrafrique-le-hcc-denonce-lusage-abusif-de-lintelligence-artificielle-pour-la-desinformation/
publisher: Centra News
...
**Reading note for the human:** this is the *state media regulator* framing AI-generated criticism of the government as a cybercrime problem, and proposing SIM-identity control as the remedy — i.e. a digital-ID/speech-control linkage. Capture is not endorsement; the piece is evidence of the regulator's position, not of the prevalence of deepfakes.
