...
provenance_note: >
  ...
  promotional register ("ambitious", "telecom giant", "fully connected society") with
  no figures and no independent assessment. Primary to source at ingest: MTN Cameroon's
  2025 investment-plan release, or ART's communiqué. Capture is not endorsement.
retrieved: 2026-07-17
sweep_batch: CMR-2026-07-17
---

<!-- Date and byline established from the page body ("Date: 2025-04-10", "By: Nana Appiah
     Acquaye"). This outlet serves no date metadata. -->

<!-- Note for ingest: thin, but it dates the **start** of the annual MTN–regulator engagement
     cycle that the 2026-04-13 and 2026-04-16 items show recurring a year later — the same
     pairing (Zoo Zame / Matandela), the same agenda. Its one substantive use is establishing
     that this is a standing ritual rather than an event. The staged 2025-06-17 ITWeb
     Camusat item supplies the figure this piece conspicuously lacks (MTN's $225m over three
     years); cite that for the money, this only for the cadence. -->

# MTN Cameroon presents 2025 strategic investment plan to telecom regulator

*Date: 2025-04-10 — By: Nana Appiah Acquaye*

MTN Cameroon has unveiled its ambitious 2025 investment strategy during a high-level meeting with the Telecommunications Regulatory Board (TRB), reinforcing its commitment to driving digital transformation and connectivity across the country. The session, held at the TRB headquarters in Yaoundé, was led by the regulator's Director General, Professor Philemon Zoo Zame, and MTN Cameroon's Chief Executive Officer, Wanda Matandela.
