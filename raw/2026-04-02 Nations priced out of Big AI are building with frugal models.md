...
Generative AI adoption is rising quickly worldwide, but there is a [wide gap](https://www.microsoft.com/en-us/corporate-responsibility/topics/ai-economy-institute/reports/global-ai-adoption-2025/): Adoption in wealthier countries grew nearly twice as fast as in low- and middle-income countries last year, according to data from Microsoft Research. The gap is likely to widen as computing power for building advanced AI systems is heavily concentrated, with U.S. and Chinese companies operating more than 90% of AI data centers that businesses and institutions rely on, according to [researchers](https://papers.ssrn.com/sol3/papers.cfm) at Oxford University. Africa and [South America](https://restofworld.org/2025/javier-milei-ai-hub-argentina-talent/) have almost no AI computing hubs.
...
Unlike the compute-heavy AI models developed by Silicon Valley, the smaller models being built in India, [Indonesia](https://restofworld.org/2024/indonesia-ai-tools-brin-government-agency/), and elsewhere can run on low-end devices and low-bandwidth networks, and be deployed in sectors such as [agriculture](https://restofworld.org/2025/malawi-ulangizi-ai-farming-chatbot/), [health-care](https://restofworld.org/2025/brazil-amazon-ai-healthcare-prescriptions/), and education. The models are not only cost-efficient, they also have a lower impact on the environment, Sathiaseelan said.
...
The launch of DeepSeek in China last year [energized advocates](https://restofworld.org/2025/deepseek-ai-model-openai-dominance-challenge/) of frugal AI. China is developing its own AI cloud and semiconductor supply chain, and its [open-source models](https://huggingface.co/spaces/open-llm-leaderboard/open_llm_leaderboard#/?official=true) have quickly become the foundation for developers and builders worldwide. Countries including India, Mexico, and Malaysia also aim to [reduce their reliance](https://restofworld.org/2025/india-mexico-malaysia-semiconductor-chip-hubs/) on expensive chip imports.

In India, [Microsoft](https://news.microsoft.com/source/asia/2025/12/09/microsoft-invests-us17-5-billion-in-india-to-drive-ai-diffusion-at-population-scale/), [Google](https://blog.google/intl/en-in/company-news/our-first-ai-hub-in-india-powered-by-a-15-billion-investment/), and [Amazon](https://www.aboutamazon.com/news/company-news/amazon-35-billion-india-investment) have all announced multibillion-dollar AI investments to tap the country’s vast data resources and market. But smaller open-source models trained on specific data for specific uses can be almost as effective as massive LLMs trained on general data, Indian tech entrepreneur Nandan Nilekani [told](https://restofworld.org/2025/nandan-nilekani-interview-india-ai/) *Rest of World* in an earlier interview.
...
[Open-weight models](https://restofworld.org/2026/current-ai-bhashini-open-source-handheld-device-2/) are more amenable to frugal AI as they eliminate proprietary API margins, can run on any infrastructure, and enable data sovereignty, “which matters enormously in non-Western contexts,” he said.

Even Western startups can benefit from a more cost-efficient approach, Lingjiao Chen, a researcher in the AI Frontiers group at Microsoft Research, who wrote a [paper](https://lingjiaochen.com/papers/2024_FrugalGPT_TMLR.pdf) on an algorithmic framework he calls FrugalGPT, told *Rest of World*.
...
The Saving Voices Project aims to reach nearly 500 million Indigenous people in 90 countries. For the communities, their knowledge and culture are intricately tied to the language, and these [need preserving](https://restofworld.org/2024/indonesia-ai-700-langagues/), Sarabani Banerjee Belur, co-founder of the project and an assistant professor at IIIT Dharwad, told *Rest of World*.
