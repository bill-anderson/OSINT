...
*Les représentants des quatre pays ont été témoins de la signature des accords.*
...
Aminata Zerbo a rappelé que ces initiatives visent à renforcer les liens entre les pays et à faire progresser l'agenda du développement numérique dans l'espace AES, et plus largement en Afrique de l'Ouest. « Ces moments de coopération sont essentiels pour consolider nos relations dans le secteur du numérique et améliorer le bien-être de nos populations », a-t-elle soutenu. Le premier accord, concernant la mise en œuvre du Free Roaming entre le Burkina Faso et le Ghana, va permettre aux citoyens du Burkina Faso et du Ghana d'utiliser leurs téléphones mobiles à des tarifs locaux, lors de leurs déplacements transfrontaliers.
