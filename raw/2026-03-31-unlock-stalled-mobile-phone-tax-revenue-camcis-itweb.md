---
type: source
title: Cameroon to unlock stalled mobile phone tax revenue
url: https://itweb.africa/article/cameroon-to-unlock-stalled-mobile-phone-tax-revenue/lwrKx73YOdEqmg1o
...
date_source: source
places: [CMR]
topics: [dpi.registry, dpi.exchange, dpi.govtech, gov.legislate, gov.protect, infra.connect, include.access]
...
<!-- Note for ingest: supplies the *history* the rest of the IMEI thread lacks — a **2022
     attempt to tax imported phones collapsed under public resistance** because the burden
     fell on end users when importers refused to pay, and because operator-side collection at
     network activation proved unworkable and unpopular. The Apr-2026 reform's design (burden
     shifted to importers, verification automated through CAMCIS) is a direct response to that
     failure. Also flags the analyst caveat that public acceptance hinges on data-protection
     safeguards and revenue transparency. -->

# Cameroon to unlock stalled mobile phone tax revenue

*By Amindeh Blaise Atabong, Contributing journalist, Johannesburg — 31 Mar 2026*
