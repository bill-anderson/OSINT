---
type: source
title: "Le gouvernement accélère-t-il la digitalisation des services publics ?"
...
# Le gouvernement accélère-t-il la digitalisation des services publics ?

*Par Gilbert Nkurunziza, Burundi Eco, 12 juin 2026.*
...
**Sweep note (not part of the source).** Caught by the FY2024/25 run's blocks 4–7 date
window; the appropriation it names is **FY2026/27** (16 milliards BIF for the CNI
biométrique in the budget bill) — the fisc-side counterpart to the ~15 mds
whole-project cost reported on 2026-05-08. Also the clearest statement on file that
the digital portfolio (e-KORI, SIGFP, Burundi Pay) is World-Bank-financed through
PAFEN, and that the **Fonds de service universel** — an own-source levy body — carries
the 1 000 health facilities / 1 000 schools connectivity commitment, undated.
Note the ministry itself now holds the *Economie Numérique* portfolio: in Burundi the
digital line does **not** sit only in the communications ministry.
