...
Many citizens in Benin now have easy access to public and private sector services thanks to a foundational identity (fID) certificate introduced thanks to the World Bank-supported [Regional West Africa Unique Identification for Regional Integration and Inclusion (WURI) project](https://www.biometricupdate.com/tag/wuri).

This is according to a World Bank [blog article](https://blogs.worldbank.org/en/nasikiliza/identification-system-in-benin-increasing-access-to-services) which explains how citizens in the west African country have been able to show proof of their identity in order to obtain important services thanks to the foundational identity system in place.
